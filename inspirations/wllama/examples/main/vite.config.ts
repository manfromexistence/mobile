...
const COMPAT_WASM = resolve(__dirname, "node_modules/@wllama/wllama-compat/wasm/wllama.wasm");
const COMPAT_JS = resolve(__dirname, "node_modules/@wllama/wllama-compat/wasm/wllama.js");
