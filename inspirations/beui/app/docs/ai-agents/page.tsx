  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="mt-3 text-muted-foreground">
        beUI exposes a static, agent-friendly surface. Connect the MCP server below, or hit the raw
        endpoints directly. Coding agents (Claude, Codex, Cursor, Amp) can list components, fetch
        source with all deps, and drop files into the user&apos;s project.
      </p>

      <h2 className="mt-10 text-xl font-semibold tracking-tight text-foreground">MCP server</h2>
      <p className="mt-2 text-muted-foreground">
        The fastest path: connect the beUI MCP server and your agent can list, search and install
        components directly. Hosted at{" "}
      ...
      <p className="mt-2 text-muted-foreground">
        The shadcn item installs source files and package dependencies. Components use shadcn
        semantic color utilities directly, so they inherit the target app&apos;s theme without
        beUI-specific color variables.
      </p>
      <div className="mt-4">
