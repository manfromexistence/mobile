        ...
        <PreviewTab>
          ...
          <Customize>
            <PreviewSlider
              ...
              step={10}
              value={defaultValue}
              onChange={(v) => updateProp("defaultValue", v)}
            />
            <PreviewSlider
              ...
              step={10}
              value={startingValue}
              onChange={(v) => updateProp("startingValue", v)}
            />
            <PreviewSlider
              title="Max Value"
              min={10}
              ...
              step={10}
              value={maxValue}
              onChange={(v) => updateProp("maxValue", v)}
            />
            <PreviewSwitch
              title="Stepped"
              isChecked={isStepped}
              onChange={(v) => updateProp("isStepped", v)}
            />
            <PreviewSlider
              title="Step Size"
              min={1}
              ...
              step={1}
              value={stepSize}
              onChange={(v) => updateProp("stepSize", v)}
            />
          </Customize>
