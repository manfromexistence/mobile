  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "[...]",
        description:
          "Array of 3 hex colors for the mesh gradient border, distributed across positions.",
      },
    ],
    [],
  );
        ...
        <PreviewTab>
            ...
            <BorderGlow {...props} colors={colors}>
              ...
              >
                ...
                <Text color="#a1a1aa" fontSize="14px" maxW="40ch" mt={1}>
                  Move your cursor close to the card border to see the colored glow effect follow
                  your pointer direction.
                </Text>
              </Flex>
            </BorderGlow>
          </Box>
          ...
          <Customize>
            ...
            <PreviewSwitch
              ...
              value={animated}
              onChange={(val) => updateProp("animated", val)}
            />
