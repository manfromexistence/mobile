...
const FluidGlassDemo = () => {
  ...
  const { mode, scale, ior, thickness, transmission, roughness, chromaticAberration, anisotropy } =
    props;
  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "{}",
        description:
          "Props specific to lens mode including material properties like ior, thickness, transmission",
      },
      {
        name: "barProps",
        type: "object",
      ...
      },
      {
        ...
        default: "{}",
        description:
          "Props specific to cube mode including material properties and interaction settings",
      },
    ],
    [],
  );
    ...
    >
      <TabsLayout>
        <PreviewTab>
          ...
          <Dependencies
            dependencyList={["three", "@react-three/fiber", "@react-three/drei", "maath"]}
          />
        </PreviewTab>
