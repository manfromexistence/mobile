  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "false",
        description:
          "If true positions the menu with fixed instead of absolute (follows viewport).",
      },
      {
        name: "items",
        type: "MenuItem[]",
        ...
        <PreviewTab>
          ...
          <Customize>
            ...
            <PreviewColorPickerCustom
              title="Menu BG"
              color={menuBg}
              onChange={(val) => updateProp("menuBg", val)}
            />
            <PreviewColorPickerCustom
              title="Content Color"
              color={menuContentColor}
              onChange={(val) => updateProp("menuContentColor", val)}
            />
