  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "0.015",
        description:
          "Base frequency for the turbulence filter. Lower values create larger, smoother patterns.",
      },
      {
        name: "numOctaves",
        type: "number",
      ...
      },
      {
        ...
        default: "400",
        description:
          "Maximum displacement scale applied when the cursor moves. Controls the intensity of the decay effect.",
      },
      {
        name: "movementBound",
        type: "number",
        default: "50",
        description:
          "Maximum pixel distance the card can translate from its origin when following the cursor.",
      },
    ],
    [],
  );
        ...
        <PreviewTab>
          ...
          <Customize>
            ...
            <PreviewSlider
              ...
              onChange={(v) => updateProp("maxDisplacement", v)}
            />
            <PreviewSlider
              ...
              step={5}
              value={movementBound}
              onChange={(v) => updateProp("movementBound", v)}
            />
          </Customize>
