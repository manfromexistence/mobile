  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: '"wait"',
        description:
          "Mode for AnimatePresence; for example, 'wait' to finish exit animations before entering.",
      },
      {
        ...
        default: "false",
        description:
          "Determines whether the AnimatePresence component should run its initial animation.",
      },
      {
      ...
      },
      {
        ...
        default: '"characters"',
        description:
          "Determines how the text is split into animatable elements (e.g., by characters, words, or lines).",
      },
      {
        name: "onNext",
        type: "function",
