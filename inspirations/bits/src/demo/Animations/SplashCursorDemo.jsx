  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "true",
        description:
          "When true, uses randomly cycling rainbow colors. When false, uses the COLOR prop.",
      },
      {
        name: "COLOR",
        type: "string",
          ...
          <PreviewTab>
            ...
            <Customize>
              <PreviewSlider
                ...
                onChange={(v) => {
                  updateProp("DENSITY_DISSIPATION", v);
                  forceRerender();
                }}
              />
              <PreviewSlider
                ...
                onChange={(v) => {
                  updateProp("VELOCITY_DISSIPATION", v);
                  forceRerender();
                }}
              />
              <PreviewSlider
              ...
              <PreviewSlider
                ...
                onChange={(v) => {
                  updateProp("COLOR_UPDATE_SPEED", v);
                  forceRerender();
                }}
              />
              <PreviewSwitch
                ...
                isChecked={SHADING}
                onChange={(v) => {
                  updateProp("SHADING", v);
                  forceRerender();
                }}
              />
              <PreviewSwitch
                title="Rainbow Mode"
                isChecked={RAINBOW_MODE}
                onChange={(v) => {
                  updateProp("RAINBOW_MODE", v);
                  forceRerender();
                }}
              />
              {!RAINBOW_MODE && (
