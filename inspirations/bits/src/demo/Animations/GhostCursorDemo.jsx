  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "0.5",
        description:
          "Velocity retention when the pointer stops. Higher values make the cursor glide longer.",
      },
      {
        name: "grainIntensity",
        type: "number",
      ...
      },
      {
        ...
        description:
          "Pixel budget. Resolution is dynamically scaled to keep total pixel count under this budget.",
      },
      {
        name: "fadeDelayMs",
        type: "number",
