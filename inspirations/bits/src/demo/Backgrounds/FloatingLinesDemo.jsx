  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "[6]",
        description:
          "Number of lines per wave. Single number applies to all waves, or array for per-wave control.",
      },
      {
        name: "lineDistance",
        type: "number | number[]",
        default: "[5]",
        description:
          "Spacing between lines. Single number applies to all waves, or array for per-wave control.",
      },
      {
        ...
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent
              ...
              headline="Waves are cool! Even cooler with lines!"
            />
          </Box>
          ...
          <Customize>
            ...
            <PreviewColorPickerCustom
              ...
              color={gradientStart}
              onChange={(v) => updateProp("gradientStart", v)}
            />
            <PreviewColorPickerCustom
              title="Gradient Mid"
              color={gradientMid}
              onChange={(v) => updateProp("gradientMid", v)}
            />
            <PreviewColorPickerCustom
              title="Gradient End"
              color={gradientEnd}
              onChange={(v) => updateProp("gradientEnd", v)}
            />
          </Customize>
