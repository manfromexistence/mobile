  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "1.0",
        description:
          "Angular width of the ray fan — higher values create a wider spread between the two ray layers",
      },
      {
        name: "origin",
      ...
      },
      {
        ...
        default: "1.0",
        description:
          "Color saturation of the rays — 0 renders in grayscale, values above 1 boost color",
      },
      {
        name: "blend",
        type: "number",
      ...
      },
      {
        ...
        default: "2.0",
        description:
          "How steeply brightness diminishes with distance from the source — higher = tighter glow",
      },
      {
        name: "opacity",
        type: "number",
        ...
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent
              ...
              headline="Light cascading from the corner"
            />
          </Box>
