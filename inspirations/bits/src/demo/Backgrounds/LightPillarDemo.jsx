  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "'screen'",
        description:
          "CSS mix-blend-mode property to control how the component blends with its background.",
      },
      {
        name: "pillarRotation",
        type: "number",
        ...
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent
              ...
              headline="Ethereal light pillar for your hero sections."
            />
          </Box>
          ...
          <Customize forceRerender={forceRerender}>
            <PreviewColorPickerCustom
              title="Top Color"
              color={topColor}
              onChange={(val) => updateProp("topColor", val)}
            />
            <PreviewColorPickerCustom
              title="Bottom Color"
              color={bottomColor}
              onChange={(val) => updateProp("bottomColor", val)}
            />
            <PreviewSlider
              title="Intensity"
              min={0.1}
