    ...
    () => [
      {
        ...
        default: "'right'",
        description:
          "Direction of square animation. Options: 'diagonal', 'up', 'right', 'down', 'left'.",
      },
      ...
      },
      {
        ...
        default: "0",
        description:
          "Number of previously hovered shapes to keep visible as a fading trail. 0 disables the trail.",
      },
    ],
    [],
  );
