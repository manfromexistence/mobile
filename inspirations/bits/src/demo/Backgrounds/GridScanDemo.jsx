    ...
    () => [
      {
        ...
        type: "boolean",
        default: "false",
        description: "Enable face tracking via webcam.",
      },
      {
        name: "showPreview",
        type: "boolean",
        default: "false",
        description: "Show webcam preview/debug HUD.",
      },
      {
        name: "modelsPath",
        type: "string",
      ...
      },
      {
        ...
        type: "number",
        default: "0.55",
        description: "Overall responsiveness to input.",
      },
      ...
      },
      {
        ...
        type: "number",
        default: "0.1",
        description: "Grid spacing scale (smaller = denser).",
      },
      {
        name: "lineStyle",
      ...
      },
      {
        ...
        type: "number",
        default: "0.1",
        description: "Animated jitter along the grid lines.",
      },
      {
        name: "enablePost",
        type: "boolean",
      ...
      },
      {
        ...
        type: "number",
        default: "0",
        description: "Bloom threshold smoothing.",
      },
      {
      ...
      },
      {
        ...
        type: "number",
        default: "0.01",
        description: "Additive film grain intensity.",
      },
      {
        name: "scanColor",
        type: "string",
        default: "'#FF9FFC'",
        description: "Color of the scan beam/aura.",
      },
      {
        name: "scanOpacity",
        type: "number",
        default: "0.4",
        description: "Opacity of the scan effect.",
      },
      {
        name: "scanDirection",
      ...
      },
      {
        ...
        type: "number",
        default: "2",
        description: "Softness of scan band edges.",
      },
      {
        name: "scanGlow",
        type: "number",
        default: "0.5",
        description: "Relative width/intensity of glow.",
      },
      {
        name: "scanPhaseTaper",
        type: "number",
        default: "0.9",
        description: "Fade-in/out window for the phase.",
      },
      {
        name: "scanDuration",
        type: "number",
        default: "2.0",
        description: "Duration of a scan cycle (seconds).",
      },
      {
        name: "scanDelay",
        type: "number",
      ...
      },
      {
        ...
        type: "boolean",
        default: "false",
        description: "Use device orientation for input.",
      },
      {
        name: "scanOnClick",
        type: "boolean",
        default: "false",
        description: "Trigger a scan when clicking.",
      },
      {
        name: "snapBackDelay",
        type: "number",
        default: "250",
        description: "Delay (ms) before input recenters.",
      },
        ...
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent
              ...
              headline="Hold on, scanning for Angular users."
            />
          </Box>
          ...
          <Customize>
            <PreviewColorPickerCustom
              title="Lines Color"
              color={linesColor}
              onChange={(val) => updateProp("linesColor", val)}
            />
            <PreviewColorPickerCustom
              title="Scan Color"
              color={scanColor}
              onChange={(val) => updateProp("scanColor", val)}
            />
            ...
            <PreviewSwitch
              title="Enable Post"
              isChecked={enablePost}
              onChange={(v) => updateProp("enablePost", v)}
            />
