  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "1",
        description:
          "Amount of domain distortion. Higher values create more chaotic, swirling motion.",
      },
      {
        name: "fluidity",
        type: "number",
        default: "0.1",
        description:
          "Smoothness of the merge between the two fluid layers. Higher = softer, more liquid blending.",
      },
      {
        name: "rimWidth",
        type: "number",
      ...
      },
      {
        ...
        default: "0.15",
        description:
          "Easing time constant (seconds) for the cursor to follow the pointer. 0 = immediate.",
      },
      {
        name: "mixBlendMode",
        type: "string",
