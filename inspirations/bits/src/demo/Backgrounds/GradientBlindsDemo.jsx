  ...
  const propData = useMemo(
    () => [
      ...
      },
      {
        ...
        default: "16",
        description:
          "Target number of vertical blinds. Acts as an upper bound when blindMinWidth is set.",
      },
      {
        name: "blindMinWidth",
        type: "number",
      ...
      },
      {
        ...
        default: "0.15",
        description:
          "Easing time constant (seconds) for the spotlight to follow the cursor. 0 = immediate.",
      },
      {
        name: "mirrorGradient",
        type: "boolean",
      ...
      },
      {
        ...
        default: "1",
        description:
          "Falloff exponent for spotlight edge. Higher = sharper edge (values >1 increase contrast).",
      },
      {
      ...
      },
      {
        ...
        default: "left",
        description:
          "Flips the bright side of each blind; useful for composition with other elements.",
      },
      {
        name: "mixBlendMode",
        type: "string",
        default: "'lighten'",
        description:
          "CSS mix-blend-mode applied to the canvas (e.g. 'screen', 'overlay', 'multiply').",
      },
      {
        name: "paused",
        type: "boolean",
        ...
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent
              ...
              headline="Smooth gradients make everything better"
            />
          </Box>
