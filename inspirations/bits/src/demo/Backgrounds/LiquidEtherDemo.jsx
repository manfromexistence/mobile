        ...
        <PreviewTab>
          <Box position="relative" className="demo-container" h={500} p={0} overflow="hidden">
            ...
            <BackgroundContent
              ...
              headline="The web, made fluid at your fingertips."
            />
          </Box>
          ...
          <Customize className="preview-options">
            <PreviewColorPickerCustom
              title="Color 1"
              color={color0}
              onChange={(val) => updateProp("color0", val)}
            />
            <PreviewColorPickerCustom
              title="Color 2"
              color={color1}
            ...
            <PreviewSwitch
              title="Bounce Edges"
              isChecked={isBounce}
              onChange={(val) => updateProp("isBounce", val)}
            />
            <PreviewSwitch
              title="Auto Animate"
              isChecked={autoDemo}
              onChange={(val) => updateProp("autoDemo", val)}
            />
            <PreviewSwitch
              title="Viscous"
              isChecked={isViscous}
              onChange={(val) => updateProp("isViscous", val)}
            />
            {isViscous && (
              <>
                <PreviewSlider
