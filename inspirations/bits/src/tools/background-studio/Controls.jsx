...
const ColorControl = ({ prop, value, onChange }) => {
  ...
  return (
    <PreviewColorPickerCustom title={label} color={value} onChange={(val) => onChange(name, val)} />
  );
};
            ...
            <Box className="cli-install-section cli-mode">
              ...
              <Box className="code-wrapper" position="relative">
                ...
                <Button
                  ...
                  _hover={{
                    backgroundColor: copied === "install" ? "#5227FF" : "var(--bg-elevated)",
                  }}
              ...
              >
                ...
                <Tooltip.Positioner>
                  <Tooltip.Content
                    ...
                    lineHeight="1.4"
                  >
                    Light backgrounds might not work well with some effects, and some effects might
