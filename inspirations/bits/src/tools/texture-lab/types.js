...
export const PRESETS = {
  "analog-film": {
    ...
    effects: [
      ...
      {
        type: EFFECT_TYPES.GRAIN,
        enabled: true,
        params: { ...DEFAULT_GRAIN_PARAMS, intensity: 0.14, size: 1.5 },
      },
      {
  ...
  "film-noir": {
    ...
    effects: [
      ...
      },
      {
        type: EFFECT_TYPES.GRAIN,
        enabled: true,
        params: { ...DEFAULT_GRAIN_PARAMS, intensity: 0.1, size: 1.3 },
      },
      {
        type: EFFECT_TYPES.VIGNETTE,
        enabled: true,
  ...
  risograph: {
    ...
    effects: [
      ...
      },
      {
        type: EFFECT_TYPES.CHROMATIC,
        enabled: true,
        params: { ...DEFAULT_CHROMATIC_PARAMS, intensity: 0.003 },
      },
      {
      ...
      },
      {
        type: EFFECT_TYPES.GRAIN,
        enabled: true,
        params: { ...DEFAULT_GRAIN_PARAMS, intensity: 0.05, size: 1.2 },
      },
    ],
  },
  "pixel-art": {
    ...
    effects: [
      {
        type: EFFECT_TYPES.PIXELATE,
        enabled: true,
        params: { ...DEFAULT_PIXELATE_PARAMS, size: 8 },
      },
      {
        type: EFFECT_TYPES.POSTERIZE,
        enabled: true,
        params: { ...DEFAULT_POSTERIZE_PARAMS, levels: 10 },
      },
      {
        type: EFFECT_TYPES.VIBRANCE,
        enabled: true,
