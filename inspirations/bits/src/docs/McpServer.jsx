...
const CLIENTS = [
  {
    key: "claude",
    icon: <img src={claude} alt="Claude Code Logo" style={IMG_STYLE} />,
    label: "Claude Code",
  },
  {
    key: "cursor",
    icon: <img src={cursor} alt="Cursor Logo" style={IMG_STYLE} />,
    label: "Cursor",
  },
  {
    key: "vscode",
    icon: <img src={vscode} alt="VS Code Logo" style={IMG_STYLE} />,
    label: "VS Code",
  },
];
      ...
      {client === "vscode" && (
        <>
          <p className="docs-paragraph">
            ...
            <span className="docs-highlight">Start</span> next to the shadcn server. Try prompts
            like:
          </p>
          <PromptList />
        </>
  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        ...
        is an open standard that enables AI assistants to securely connect to external data sources
        and tools.
      </p>

      <p className="docs-paragraph dim">
        React Bits encourages the use of the shadcn MCP server to browse, search, and install
        components using natural language.
      </p>
      ...
      <p className="docs-paragraph">
        ...
        <span className="docs-highlight">components.json</span> file, where you should first add the{" "}
        <span className="docs-highlight">@react-bits</span> registry:
      </p>
  ...
  "registries": {
    "@react-bits": "https://reactbits.dev/r/{name}.json"
      ...
      <p className="docs-paragraph dim" style={{ marginBottom: "16px" }}>
        To learn more about using the shadcn MCP server, including manual setup for different
        clients, please visit the official documentation:
      </p>
