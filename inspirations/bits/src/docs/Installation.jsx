...
const ManualSteps = () => (
  <>
    ...
    <p className="docs-paragraph short">
      ...
      <span className="docs-highlight">Manual</span>, copying the command, and running it in your
      terminal.
    </p>
    ...
    <p className="docs-paragraph short">
      The <span className="docs-highlight">Code</span> tab also contains all the code you need to
      copy - you can use the controls below to switch between technologies on the Code tab.
    </p>
    ...
    <p className="docs-paragraph short">
      A basic usage example is provided for every component, and if you want to go into details, you
      can check all the available props on the <span className="docs-highlight">Preview</span> tab.
    </p>
...
const CliSteps = () => (
  <>
    ...
    <p className="docs-paragraph short">
      Below are example commands for the SplitText component. Replace placeholders to fit your
      stack.
    </p>
    ...
    <p className="docs-paragraph dim" style={{ marginTop: "1rem" }}>
      Tip: You can run these with other package managers (pnpm, yarn, bun) - just swap the prefix
      (e.g. <code>pnpm dlx</code> or <code>yarn</code> instead of <code>npx</code>).
    </p>
  </>
);
...
const Installation = () => {
  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph">
        You can keep it simple and copy code directly from the documentation, or you can use CLI
        commands to install components into your project.
      </p>
      ...
      <p className="docs-paragraph">
        From here on, it&apos;s all about how you integrate the component into your project. The
        code is yours to play around with - modify styling, functionalities, anything goes!
      </p>
