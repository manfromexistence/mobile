...
const VARIANT_LINKS = [
  {
    label: "JavaScript + CSS (default)",
    path: "src/content",
    note: "Plain CSS styling; copyable into any React app.",
  },
  {
...
const KEY_DEPENDENCIES = [
  {
    ...
    note: "Animation engine used by many motion components.",
  },
  {
    label: "Motion (Framer)",
  ...
  },
  {
    ...
    note: "3D engine for backgrounds and interactive visuals.",
  },
  {
    label: "ogl",
    url: "https://github.com/oframe/ogl",
    note: "Lightweight WebGL; shader-driven backgrounds.",
  },
];
...
function main() {
  ...
  console.log(
    `Generated ${path.relative(process.cwd(), OUTPUT_PATH)} with dynamic component index.`,
  );
}
