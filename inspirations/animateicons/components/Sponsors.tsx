...
import { DollarSignIcon, DollarSignIconHandle } from "../icons/lucide/dollar-sign-icon";
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                ...
                >
                  <CoffeeIcon ref={coffeeRef} className="size-4.5 text-yellow-400" />
                  ...
                  <div className="flex w-full items-center justify-between">
                    ...
                    <span className="size-4">
                      {copied ? (
                        ...
                        <CopyIcon ref={copyRef} className="size-3.5 text-gray-400" />
                      )}
                    </span>
                  </div>
