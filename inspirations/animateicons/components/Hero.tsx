    ...
    <div className="relative flex min-h-[calc(100dvh-4rem)] items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-textPrimary font-medium">with AnimateIcons</span>
        </motion.h1>
        ...
        >
          <p>
            Free and open-source animated SVG icons for React with smooth micro-interactions and
            lightweight performance, built with{" "}
            <Link href={"https://motion.dev/"} className="underline" target="_blank">
              Motion
            </Link>
          </p>
        </motion.div>

        <motion.div variants={itemVariants} className="flex w-full items-center justify-center">
          <CmdSection />
        </motion.div>
