...
import { ArrowLeft, ArrowRight, Coffee, CreditCard, Heart, Wallet, X } from "lucide-react";
            ...
            {view === "main" ? (
              <div className="relative space-y-5 px-6 py-7 sm:px-8 sm:py-8">
                <div className="space-y-3">
                  ...
                  <p className="text-textSecondary text-sm leading-relaxed">
                    Hey, I&apos;m Avijit, the solo developer behind AnimateIcons. This site is{" "}
                  ...
                  <p className="text-textSecondary text-sm leading-relaxed">
                    I&apos;m not earning anything from this project. No ads, no sponsors yet, no
                    paid tiers. Every icon is free and always will be. If AnimateIcons saved you
                    time, even a small one-time tip would genuinely help me cover hosting and keep
                    building.
                  </p>
                    ...
                    const inner = (
                      <>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-textPrimary text-sm font-semibold">{label}</span>
                        </div>
                        <span className="text-textMuted text-[11px]">{subtitle}</span>
                      </>
                    );
                    if (href) {
                      return (
              ...
              <div className="relative space-y-5 px-6 py-7 sm:px-8 sm:py-8">
                ...
                <div className="border-border/60 flex items-center justify-between gap-3 rounded-xl border bg-gradient-to-b from-white/[0.03] to-white/[0.01] px-3 py-2">
                  <code className="text-textPrimary truncate font-mono text-sm">{UPI_ID}</code>
                  <button
                    type="button"
                    onClick={copyUpi}
