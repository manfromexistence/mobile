...
const V0Icon = forwardRef<V0IconHandle, V0IconProps>(
  ({ className, size = 28, duration = 1, onMouseEnter, onMouseLeave, ...props }, ref) => {
    const id = useId();
    ...
    const handleEnter = useCallback(
      ...
      [groupControls, leftControls, rightControls, shineControls, reduced, onMouseEnter],
    );
    ...
    return (
      ...
      >
        ...
        >
          ...
          <motion.g initial="rest" animate={leftControls} variants={leftVariants}>
            <motion.path
          ...
          <motion.g initial="rest" animate={rightControls} variants={rightVariants}>
            <motion.path
