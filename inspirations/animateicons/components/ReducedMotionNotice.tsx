          ...
          >
            ...
            <div className="flex items-start gap-3 p-4 pr-10">
              ...
              <div className="flex-1 space-y-1">
                <p className="text-textPrimary text-sm font-semibold">Animations are turned off</p>

                <p className="text-textSecondary text-xs leading-relaxed">
                  Your system has Reduce Motion enabled, so icon animations are disabled. Turn off
                  &ldquo;Reduce Motion&rdquo; in your system settings to experience full animations.
                </p>
              </div>
            </div>
          </div>
