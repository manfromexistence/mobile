...
const IconLibrariesSection: React.FC = () => {
  ...
  const active = iconLibraries.find((l) => l.id === activeId) ?? iconLibraries[0];
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div
          ...
          style={{
            ...
            maskImage: "radial-gradient(50% 60% at 50% 50%, black, transparent 80%)",
            WebkitMaskImage: "radial-gradient(50% 60% at 50% 50%, black, transparent 80%)",
          }}
        />
      </div>
