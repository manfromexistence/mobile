...
export const iconLibraries: IconLibraryCardData[] = [
  {
    id: "lucide",
    title: "Lucide Icons",
    description: "Minimal icons with precise motion, ideal for modern product interfaces.",
  ...
  },
  {
    id: "huge",
    title: "Huge Icons",
    description: "Bold and expressive icons designed for dashboards and rich interfaces.",
