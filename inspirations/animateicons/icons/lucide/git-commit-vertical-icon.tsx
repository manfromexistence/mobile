...
interface GitCommitVerticalIconProps
  extends Omit<
...
const GitCommitVerticalIcon = forwardRef<GitCommitVerticalIconHandle, GitCommitVerticalIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
      ...
      <LazyMotion features={domMin} strict>
        ...
        >
          <m.svg
            ...
            animate={controls}
          >
            <m.path d="M12 3v6" variants={topLineVariants} initial="normal" animate={controls} />
