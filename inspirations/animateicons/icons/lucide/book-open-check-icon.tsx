...
interface BookOpenCheckIconProps
  extends Omit<
...
const BookOpenCheckIcon = forwardRef<BookOpenCheckIconHandle, BookOpenCheckIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.path d="M12 21V7" variants={spineVariants} initial="normal" animate={controls} />
            <m.path
              d="m16 12 2 2 4-4"
