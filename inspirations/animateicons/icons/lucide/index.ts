...
import { RussianRubleIcon } from "./russian-ruble-icon";
import { SaudiRiyalIcon } from "./saudi-riyal-icon";
...
const ICON_LIST: IconListItem[] = [
  ...
  },
  {
    ...
    addedAt: "2026-02-16",
    category: ["Notification"],
    keywords: ["warning", "alert", "error", "danger", "caution", "issue", "problem"],
  },
  {
    name: "lock",
    icon: LockIcon,
  ...
  },
  {
    ...
    addedAt: "2026-01-17",
    category: ["Emoji"],
    keywords: ["irritated", "unimpressed", "tired", "minor error", "subtle feedback"],
  },
  {
    name: "coffee",
    icon: CoffeeIcon,
