...
interface PhoneForwardedIconProps
  extends Omit<
...
const PhoneForwardedIcon = forwardRef<PhoneForwardedIconHandle, PhoneForwardedIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.path d="M14 6h8" variants={arrowVariants} initial="normal" animate={controls} />
            <m.path
              d="m18 2 4 4-4 4"
