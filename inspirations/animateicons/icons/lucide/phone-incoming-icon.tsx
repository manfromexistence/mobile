...
interface PhoneIncomingIconProps
  extends Omit<
...
const PhoneIncomingIcon = forwardRef<PhoneIncomingIconHandle, PhoneIncomingIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.path d="M16 2v6h6" variants={arrowVariants} initial="normal" animate={controls} />
            <m.path d="m22 2-6 6" variants={arrowVariants} initial="normal" animate={controls} />
            <m.path
