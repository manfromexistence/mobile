...
const ChevronsLeftIcon = forwardRef<ChevronsLeftIconHandle, ChevronsLeftIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
      ...
      <LazyMotion features={domMin} strict>
        ...
        >
          <m.svg
            ...
            initial="normal"
          >
            <m.path d="m18 17-5-5 5-5" variants={trailingArrow} stroke="currentColor" />
            <m.path d="m11 17-5-5 5-5" variants={leadingArrow} stroke="currentColor" />
          </m.svg>
        </m.div>
      </LazyMotion>
    );
