...
interface ChartNoAxesCombinedIconProps
  extends Omit<
...
>(
  (
    ...
    const handleEnter = useCallback(
      ...
      [groupControls, barsControls, lineControls, reduced, onMouseEnter, isAnimated],
    );
    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.path d="M12 16v5" initial="normal" animate={barsControls} variants={barVariant(0)} />
            <m.path
              d="M16 14v7"
              initial="normal"
