...
interface PhoneMissedIconProps
  extends Omit<
    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.path d="m16 2 6 6" variants={crossVariants} initial="normal" animate={controls} />
            <m.path d="m22 2-6 6" variants={crossVariants} initial="normal" animate={controls} />
            <m.path
