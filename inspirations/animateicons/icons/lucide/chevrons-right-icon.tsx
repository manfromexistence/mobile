...
const ChevronsRightIcon = forwardRef<ChevronsRightIconHandle, ChevronsRightIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
      ...
      <LazyMotion features={domMin} strict>
        ...
        >
          <m.svg
            ...
            initial="normal"
          >
            <m.path d="m6 17 5-5-5-5" variants={trailingArrow} stroke="currentColor" />
            <m.path d="m13 17 5-5-5-5" variants={leadingArrow} stroke="currentColor" />
          </m.svg>
        </m.div>
      </LazyMotion>
    );
