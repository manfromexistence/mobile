    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.g variants={groupVariants} custom={2} animate={controls} initial="normal">
            ...
            <m.g variants={groupVariants} custom={1} animate={controls} initial="normal">
            ...
            <m.g variants={groupVariants} custom={0} animate={controls} initial="normal">
