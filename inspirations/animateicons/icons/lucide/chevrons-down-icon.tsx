...
export interface ChevronsDownIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}
...
const ChevronsDownIcon = forwardRef<ChevronsDownIconHandle, ChevronsDownIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
      ...
      <LazyMotion features={domMin} strict>
        ...
        >
          <m.svg
            ...
            initial="normal"
          >
            <m.path d="m7 6 5 5 5-5" variants={trailingChevron} stroke="currentColor" />
            <m.path d="m7 13 5 5 5-5" variants={leadingChevron} stroke="currentColor" />
          </m.svg>
        </m.div>
      </LazyMotion>
    );
