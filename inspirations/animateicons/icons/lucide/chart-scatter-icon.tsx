...
interface ChartScatterIconProps
  extends Omit<
    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.circle cx="7.5" cy="7.5" r=".5" fill="currentColor" variants={dotVariants} />
            <m.circle cx="18.5" cy="5.5" r=".5" fill="currentColor" variants={dotVariants} />
            <m.circle cx="11.5" cy="11.5" r=".5" fill="currentColor" variants={dotVariants} />
            <m.circle cx="7.5" cy="16.5" r=".5" fill="currentColor" variants={dotVariants} />
            <m.circle cx="17.5" cy="14.5" r=".5" fill="currentColor" variants={dotVariants} />
