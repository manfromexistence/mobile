    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.path d="M2 20h.01" variants={dotVariants} initial="normal" animate={controls} />
            <m.path d="M7 20v-4" variants={barPulse(0.1)} initial="normal" animate={controls} />
            <m.path d="M12 20v-8" variants={barPulse(0.25)} initial="normal" animate={controls} />
            <m.path d="M17 20V8" variants={barPulse(0.4)} initial="normal" animate={controls} />
            <m.path d="M22 4v16" variants={barPulse(0.55)} initial="normal" animate={controls} />
          </m.svg>
        </m.div>
      </LazyMotion>
    );
