...
export interface Compass01IconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface Compass01IconProps
  extends Omit<
...
const Compass01Icon = forwardRef<Compass01IconHandle, Compass01IconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
        ...
        >
          ...
          >
            ...
            >
              ...
              <path d="M12 12L11.9936 12.0064" strokeWidth="2" strokeLinecap="round" />
            </m.g>
          </m.svg>
        </m.div>
      </LazyMotion>
