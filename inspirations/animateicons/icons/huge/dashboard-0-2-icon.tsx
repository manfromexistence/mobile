...
interface Dashboard02IconProps
  extends Omit<
        ...
        >
          ...
          >
            ...
            <m.g variants={gridVariants} initial="normal" animate={controls}>
              <m.g variants={tileVariants} custom={0} initial="normal" animate={controls}>
              ...
              <m.g variants={tileVariants} custom={1} initial="normal" animate={controls}>
              ...
              <m.g variants={tileVariants} custom={2} initial="normal" animate={controls}>
              ...
              <m.g variants={tileVariants} custom={3} initial="normal" animate={controls}>
