...
function findIconLines(filePath: string, source: "huge" | "lucide", prefix: string): IconEntry[] {
...
function buildIconEntries(): IconEntry[] {
  ...
  return [...findIconLines(hugeFile, "huge", "hu"), ...findIconLines(lucideFile, "lucide", "lu")];
}
...
function main() {
  ...
  console.log("Please ensure each icon name is unique within and across libraries.\n");
