import { fetchCatalog, fetchRegistryItem, resolveIcon, writeIcon } from "@animateicons/core";
 ...
 */
export async function runAdd(names: string[], opts: AddOptions): Promise<AddOutcome> {
