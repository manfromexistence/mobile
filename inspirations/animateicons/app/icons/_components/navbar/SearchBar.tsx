  ...
  return (
    <div className="flex w-full md:w-70">
      <InputGroup className="border-border bg-surfaceElevated rounded-full">
        ...
        <InputGroupAddon align="inline-end" className="text-textSecondary! gap-1">
          {showEsc ? (
            <Kbd className="bg-surface text-textSecondary! text-[0.65rem]!">ESC</Kbd>
          ) : (
            <>
              <Kbd className="bg-surface text-textSecondary! text-[0.65rem]!">
                {isMac ? "⌘" : "Ctrl"}
              </Kbd>
              <Kbd className="bg-surface text-textSecondary! text-[0.65rem]!">K</Kbd>
            </>
          )}
        </InputGroupAddon>
      </InputGroup>
