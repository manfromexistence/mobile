...
const AppSidebar: React.FC = () => {
  ...
  const activeNavHref = (sidebarConfig.find((g) => g.label === "Navigation")?.items ?? [])
    .map((i) => i.href)
    ...
    <Sidebar className="border-border/50! bg-surface text-textPrimary border-r">
      ...
      <SidebarContent className="bg-bgDark gap-2">
                    ...
                    <>
                      {customIcon
                        ...
                        : Icon && (
                            <Icon
                              className={
                                highlight ? "size-4 fill-pink-500/20 text-pink-500" : "size-4"
                              }
                            />
                          )}
        ...
        <SidebarGroup className="min-h-50 flex-1 overflow-y-auto">
          <SidebarGroupLabel className="text-textSecondary text-xs">Categories</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu className="gap-[0.563rem]">
              <SidebarMenuItem key="all">
                ...
                >
                  ...
                  <span className="text-textSecondary text-xs">{totalCount}</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              ...
              {categories.map((cat) => (
                <SidebarMenuItem key={cat.name}>
                  ...
                  >
                    ...
                    <span className="text-textSecondary text-xs">{cat.count}</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              ))}
            </SidebarMenu>
