...
import { useIconConfig, type IconConfig } from "@/app/icons/_components/playground/useIconConfig";
...
const IconDetailPlayground: React.FC<Props> = ({ Icon, componentName, library }) => {
  ...
  const snippet = useMemo(() => buildSnippet(componentName, config), [componentName, config]);
