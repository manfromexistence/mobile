...
const IconSearchInputContext = createContext<IconSearchInputContextValue | null>(null);
const IconSearchResultContext = createContext<IconSearchResultContextValue | null>(null);
...
export const useIconSearchResult = () => {
  ...
  if (!ctx) {
    throw new Error("useIconSearchResult must be used inside IconSearchProvider");
  }
  return ctx;
};
