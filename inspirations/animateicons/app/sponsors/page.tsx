...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "The people keeping AnimateIcons online. Funded entirely by tips and sponsors.",
    url: "/sponsors",
  },
};
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:py-20">
          <div className="space-y-4">
            ...
            <p className="text-textSecondary max-w-2xl text-sm leading-relaxed sm:text-base">
              AnimateIcons is an independent, open-source library maintained without ads, paid
              tiers, or corporate backing. The contributors below directly fund hosting and ongoing
              development, keeping every icon free for the community.
            </p>
          </div>
          ...
          <div className="border-border/60 mt-12 rounded-2xl border bg-gradient-to-b from-white/[0.03] to-white/[0.01] p-6 sm:p-8">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-1">
                <p className="text-textPrimary text-base font-semibold">Support the project</p>
                <p className="text-textSecondary text-sm">
                  Both one-time contributions and recurring sponsorships are recognized below.
                </p>
              </div>
          ...
          <p className="text-textMuted mt-8 text-center text-xs">
            Data refreshes hourly. Anonymous and privacy-hidden tips aren&apos;t shown.
          </p>
        </section>
      </main>
      <Footer />
