...
export const dotGridDef: ShaderDef = {
  ...
  params: [
    ...
    },
    {
      ...
      description:
        "Random variation in shape size (0 = uniform size, higher = random value up to base size)",
    },
    {
      name: "opacityRange",
      type: "number",
      ...
      description:
        "Random variation in shape opacity (0 = all shapes opaque, higher = semi-transparent dots)",
    },
    ...staticCommonParams,
  ],
};
