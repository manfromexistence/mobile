...
> = {
  ...
  "clip-paths": {
    ...
    description: "Create and customize SVG clip-path shapes for modern web design",
  },
  "color-lab": {
    name: "Color Lab",
    description: "Generate color palettes, convert between formats, and create Shadcn UI themes",
  },
  "mesh-gradients": {
    name: "Mesh Gradient Generator",
    description: "Create beautiful mesh gradients and fluid color transitions for web designs",
  },
  shadows: {
    name: "CSS Shadow Generator",
    description: "Generate beautiful CSS and Tailwind CSS box-shadows and text-shadows",
  },
  "svg-line-draw": {
    name: "SVG Line Draw",
    description: "Create hand-drawn SVG lines, arrows, and animations for web design",
  },
};
