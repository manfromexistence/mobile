        ...
        <div
          ...
          className={`absolute ${index < 3 ? "h-[121px] w-[443px]" : "h-[207px] w-[756px]"} ${
            index === 0
              ...
              : index === 1
                ? "-translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 rotate-[164.971deg] mix-blend-difference"
                : index === 2
                  ? "-translate-x-[53%] -translate-y-[53%] top-1/2 left-1/2 rotate-[-11.61deg] mix-blend-difference"
                  : index === 3
                    ? "-translate-x-1/2 -translate-y-[57%] top-1/2 left-1/2 rotate-[-179.012deg] mix-blend-difference"
                    : index === 4
                      ? "-translate-x-[57%] -translate-y-1/2 top-1/2 left-1/2 rotate-[-29.722deg] mix-blend-difference"
                      : index === 5
                        ? "-translate-x-[62%] -translate-y-[24%] top-1/2 left-1/2 rotate-[160.227deg] mix-blend-difference"
