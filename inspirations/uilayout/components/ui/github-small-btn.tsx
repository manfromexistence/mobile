...
const GitHubSmallButton: React.FC = () => {
	...
	return (
		<div className="flex justify-center">
			<a
				...
				target="_blank"
				className="group relative mx-auto inline-block h-11 w-10 rounded-lg border-2 border-black bg-white sm:w-12 dark:border-white dark:bg-black"
				rel="noreferrer"
			>
				...
				>
					<Github className="inline-block h-6 w-6 flex-shrink-0 fill-white stroke-0" />
				</button>
			</a>
		</div>
	);
...
export default GitHubSmallButton;
