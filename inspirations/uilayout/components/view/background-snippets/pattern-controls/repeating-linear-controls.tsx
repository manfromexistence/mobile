    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="mt-2 grid grid-cols-4 gap-2">
          <Button variant="outline" size="sm" onClick={() => setRepeatingLinearAngle(0)}>
            0° →
          </Button>
          <Button variant="outline" size="sm" onClick={() => setRepeatingLinearAngle(45)}>
            45° ↗
          </Button>
          <Button variant="outline" size="sm" onClick={() => setRepeatingLinearAngle(90)}>
            90° ↑
          </Button>
          <Button variant="outline" size="sm" onClick={() => setRepeatingLinearAngle(135)}>
            135° ↖
          </Button>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <Label className="inline-block">Line Spacing: {repeatingLinearSize}px</Label>
        <CustomSlider
