            ...
            >
              <div className="flex items-center justify-between pt-10 pb-4">
                ...
                <div className="flex items-center gap-2">
                  <Button variant="outline" size="sm" onClick={() => setShowV4(!showV4)}>
                ...
                >
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => copyToClipboard(showV4 ? maskCodeV4 : maskCodeV3, "mask")}
                      className="flex items-center gap-1"
                    >
                      {copied.mask ? (
                        <>
                ...
                >
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        copyToClipboard(showV4 ? gradientCodeV4 : gradientCodeV3, "gradient")
                      }
                      className="flex items-center gap-1"
                    >
                      {copied.gradient ? (
              ...
              >
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => copyToClipboard(showV4 ? fullCodeV4 : fullCodeV3, "full")}
                    className="flex items-center gap-1"
                  >
                    {copied.full ? (
                      <>
