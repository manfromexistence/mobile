    ...
    <>
      <div className="space-y-2">
        ...
        <div className="mt-2 grid grid-cols-4 gap-2">
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(0)}>
            0° →
          </Button>
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(45)}>
            45° ↗
          </Button>
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(90)}>
            90° ↑
          </Button>
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(135)}>
            135° ↖
          </Button>
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(180)}>
            180° ←
          </Button>
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(225)}>
            225° ↙
          </Button>
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(270)}>
            270° ↓
          </Button>
          <Button variant="outline" size="sm" onClick={() => setLinearGradientAngle(315)}>
            315° ↘
          </Button>
        </div>
      </div>
      ...
      <div className="mt-6">
        ...
        <p className="mb-4 text-muted-foreground text-xs">
          Drag the color stops to adjust their positions. The gradient will always maintain stops at
          0% and 100%.
        </p>

        <div className="flex flex-wrap gap-2 pr-2">
          {gradientStops.map((stop, index) => (
            <div key={index} className="relative w-fit rounded-md border bg-card-bg px-2 py-1">
