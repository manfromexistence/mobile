...
export default function ShadowControls({
  ...
  const updateAllLayersPosition = (property: "offsetX" | "offsetY", value: number) => {
      ...
      <div className="flex items-center justify-between pb-4">
        ...
        <Tooltip>
          ...
          <TooltipContent className="max-w-sm">
            <p>
              Add multiple shadow layers to create complex effects. Each layer can have its own
              properties.
            </p>
          </TooltipContent>
        </Tooltip>
      ...
      <div className="space-y-6">
              ...
              >
                <Button
                  ...
                  className={`h-8 w-10 shrink-0 border-0 bg-transparent text-xs shadow-none hover:bg-transparent 2xl:w-12 dark:inset-shadow-none ${
                    activeLayerIndex === index ? "text-primary-foreground" : "text-primary"
                  }`}
                >
        ...
        <div className="rounded-md border bg-main p-3">
          <div className="mb-2 flex items-center justify-between">
            <Label className="font-medium text-black text-sm dark:text-white">Shadow Colors</Label>
          </div>

          {layers.length > 1 && (
            <p className="mb-2 text-muted-foreground text-xs dark:text-gray-400">
              This shadow uses multiple colors. Click on a color to edit all instances.
            </p>
          )}
                ...
                {activeLayerIndex === index ? (
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        />
                        <span className="text-xs">{layers[activeLayerIndex].color}</span>
                        <span className="ml-1 text-muted-foreground text-xs">({index + 1})</span>
                      </Button>
                    </PopoverTrigger>
                        ...
                        <div className="flex justify-center">
                          <ChromePicker
                            ...
                            onChange={(colorResult) => {
                              updateLayer(activeLayerIndex, "color", colorResult.hex);
                            }}
                            disableAlpha={true}
                          />
                        </div>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              if (/^#[0-9A-F]{6}$/i.test(e.target.value)) {
                                updateLayer(activeLayerIndex, "color", e.target.value);
                              }
                            }}
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>Switch to ({index + 1}) layer using this color to edit it</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                )}
        ...
        <div className="space-y-3 rounded-lg border bg-main p-4">
          ...
          <div className="flex justify-between gap-4">
            <div>
              ...
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="outer" id="outer" className="dark:border-gray-600" />
                  <Label htmlFor="outer" className="dark:text-gray-300">
                    Outer Shadow
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="inner" id="inner" className="dark:border-gray-600" />
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      globalMasterMode || globalOpacityMode
                        ...
                        : updateLayer(activeLayerIndex, "opacity", clampedValue);
                    }}
                    min={0}
                    max={100}
                    className="h-8 w-16 bg-card-bg text-center"
