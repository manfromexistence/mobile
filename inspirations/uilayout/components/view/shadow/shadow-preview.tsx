      ...
      <Tabs defaultValue="preview" className="relative h-full w-full">
          ...
          <div className="absolute top-2 left-2 flex items-center gap-1">
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="max-w-sm">Check Without Shadow</TooltipContent>
              </Tooltip>
              <Dialog>
                <DialogTrigger asChild>
                  <Button
                    ...
                    size="icon"
                    disabled={!isEdited}
                    className={cn("", !isEdited ? "cursor-not-allowed opacity-50" : "")}
                  >
                    <Save />
                  </Button>
                </DialogTrigger>
                  ...
                  <div className="rounded-md border bg-main p-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        disabled={!isEdited}
                        className={!isEdited ? "cursor-not-allowed opacity-50" : ""}
                      >
        ...
        <TabsContent value="code" className="mt-0">
          <div className="w-full overflow-y-hidden rounded-xl border bg-card-bg p-4 dark:inset-shadow-[0_1px_rgb(255_255_255/0.15)] dark:border-0">
            <h3 className="mb-4 font-medium text-lg">How to use in your project</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h4 className="mb-2 font-medium">Extending Tailwind Config (v3)</h4>
                <div className="relative">
                  <CopyToClipboard
                    text={`module.exports = {
  theme: {
    ...
    extend: {
      boxShadow: {
        '${activeShadow?.shadowName || activeShadow?.name || "custom"}': '${cssValue}',
                ...
                <h4 className="mt-1 mb-2 font-medium">Extending global.css (v4)</h4>
                <div className="relative">
                  <CopyToClipboard
                    text={`
...
@theme {
  ...
  `}
                ...
                <p className="mt-2 text-muted-foreground text-sm dark:text-gray-400">
                  Then use it with:{" "}
                  <code className="rounded bg-main px-1 py-0.5">shadow-custom</code>
                </p>
              </div>
            </div>
