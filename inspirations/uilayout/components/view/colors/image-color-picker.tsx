...
export function ImageColorPicker({ setHexValue, hexValue }: ImageColorPickerProps) {
      ...
      >
        {image ? (
          <div className="relative">
            <div ref={imageContainerRef} className={`relative ${eyedropperCursorStyle}`}>
              <img
                ref={imageRef}
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <h4 className="mb-2 font-medium text-lg">Drop image here or click to upload</h4>
