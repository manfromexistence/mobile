...
import type { CmykColor, HslColor, HslaColor, HsvColor, RgbColor, RgbaColor } from "@/types/color";
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="outline" size="icon" onClick={() => copyToClipboard(hexValue)}>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      copyToClipboard(`rgb(${rgbValues.r}, ${rgbValues.g}, ${rgbValues.b})`)
                    }
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      copyToClipboard(`hsl(${hslValues.h}, ${hslValues.s}%, ${hslValues.l}%)`)
                    }
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      copyToClipboard(`hsv(${hsvValues.h}°, ${hsvValues.s}%, ${hsvValues.v}%)`)
                    }
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
