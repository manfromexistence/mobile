...
interface AllColorFormatsProps {
  ...
  formatHandlers: Record<string, (e: React.ChangeEvent<HTMLInputElement>) => void>;
}

export function AllColorFormats({ colorFormats, formatHandlers }: AllColorFormatsProps) {
