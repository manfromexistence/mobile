...
import { getAccessibilityLevel, getContrastRatio, hexToRgb } from "@/lib/color-utils";
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="font-medium text-lg">Color Contrast Checker</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    />
                    <div className="flex-1 px-2 font-mono text-xs">{foreground}</div>
                  </Button>
                </PopoverTrigger>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    />
                    <div className="flex-1 px-2 font-mono text-xs">{background}</div>
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-3" align="start">
        ...
        <div className="space-y-3">
          <div className="text-center">
            ...
            <div className="font-bold text-2xl">{contrastRatio.toFixed(2)}:1</div>
        ...
        <div className="space-y-2 text-sm">
          ...
          <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
            <li>
              <span className="font-medium">AA</span>: Minimum ratio of 4.5:1 for normal text, 3:1
              for large text
            </li>
            <li>
              <span className="font-medium">AAA</span>: Enhanced ratio of 7:1 for normal text, 4.5:1
              for large text
            </li>
            <li>
              <span className="font-medium">Large text</span> is defined as 18pt (24px) or 14pt
              (18.5px) bold
            </li>
          </ul>
        </div>
