      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <Card className="shadow-xl">
          <CardHeader className="pb-2">
            ...
            <div className="text-muted-foreground text-xs">Set your daily activity goal</div>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center justify-center space-y-2">
              <div className="flex items-center">
                ...
                <div className="mx-4 text-center">
                  ...
                  <div className="text-muted-foreground text-xs">CALORIES/DAY</div>
                </div>
                <Button variant="outline" size="icon" className="h-8 w-8 rounded-full">
              ...
              <div className="mt-2 h-[60px] w-full">
                <div className="flex h-full items-end justify-between gap-1">
                  {[0.6, 0.8, 0.7, 0.9, 0.6, 0.7, 0.8, 0.9, 0.7, 0.8].map((height, i) => (
                    <div
                      key={i}
        ...
        <Card className="shadow-xl">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                <CardTitle className="font-medium text-sm">Sofia Davis</CardTitle>
                <div className="text-muted-foreground text-xs">sd@example.com</div>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-2">
            <div className="rounded-md bg-muted/50 p-2 text-sm">Hi, how can I help you today?</div>

            <div className="ml-auto max-w-[80%] rounded-md bg-primary/10 p-2 text-sm">
              Hey, I'm having trouble with my account.
            </div>

            <div className="rounded-md bg-muted/50 p-2 text-sm">What seems to be the problem?</div>
        ...
        <Card className="shadow-xl">
          <CardHeader className="pb-2">
            <CardTitle className="font-medium text-sm">Payment Method</CardTitle>
        ...
        <Card className="shadow-xl">
          <CardHeader className="pb-2">
            <CardTitle className="font-medium text-lg">Create an account</CardTitle>
        ...
        <Card className="shadow-xl">
          <CardHeader className="pb-2">
            <CardTitle className="font-medium text-lg">Report an issue</CardTitle>
            <div className="text-muted-foreground text-sm">
        ...
        <Card className="shadow-xl">
          <CardHeader className="pb-2">
            ...
            <div className="text-muted-foreground text-xs">Manage your payments</div>
          </CardHeader>
          <CardContent>
              ...
              <TabsContent value="account" className="mt-2 p-2">
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>Control your notification settings.</AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-3">
                    <AccordionTrigger>Settings</AccordionTrigger>
                    <AccordionContent>Control your profile settings.</AccordionContent>
                  </AccordionItem>
                </Accordion>
              </TabsContent>
            ...
            <div className="flex items-center justify-between rounded-md p-2 hover:bg-muted/50">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground text-xs">jl@example.com</div>
                </div>
              </div>
              <Button variant="ghost" size="icon" className="h-8 w-8">
                <User className="h-4 w-4" />
        ...
        <Card className="shadow-xl">
          <CardHeader className="pb-2">
            <CardTitle className="font-medium text-sm">Cookie Settings</CardTitle>
            <div className="text-muted-foreground text-xs">Manage your cookie settings here</div>
          </CardHeader>
          <CardContent className="space-y-4">
