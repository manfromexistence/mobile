  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="font-medium text-lg">Gradient Generator</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <Tabs
          value={gradientType}
          onValueChange={(value) => setGradientType(value as typeof gradientType)}
        >
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    />
                    <div className="flex-1 px-2 font-mono text-xs">{startColor}</div>
                  </Button>
                </PopoverTrigger>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    />
                    <div className="flex-1 px-2 font-mono text-xs">{endColor}</div>
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-3" align="start">
