...
export function ColorBlindnessSimulator({ hexValue }: ColorBlindnessSimulatorProps) {
  ...
  const renderSimulation = () => {
    ...
    const simulatedColor = simulateColorBlindness(rgb.r, rgb.g, rgb.b, simulationType);
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="font-medium text-lg">Color Blindness Simulator</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <Tabs
          value={simulationType}
          onValueChange={(value) => setSimulationType(value as typeof simulationType)}
        >
          ...
          <div className="mt-4">
            <p className="text-muted-foreground text-sm">{getSimulationDescription()}</p>
          </div>
        </Tabs>
        ...
        <div className="space-y-2 text-sm">
          ...
          <p className="text-muted-foreground">
            About 8% of men and 0.5% of women have some form of color blindness. Design with
            sufficient contrast and don't rely solely on color to convey important information.
          </p>
        </div>
      </CardContent>
    </Card>
