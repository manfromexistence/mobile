...
export function CustomLineInput({ activePresets, setActivePresets }: CustomLineInputProps) {
  ...
  const { customLines, addCustomLine, removeCustomLine, clearCustomLines } = useSvgStore();
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardDescription>Add custom SVG path data to create animations</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={strokeLinecap}
              onValueChange={(value) => setStrokeLinecap(value as "butt" | "round" | "square")}
            >
              <SelectTrigger>
        ...
        {customLines.length > 0 && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-medium text-sm">Saved Custom Lines ({customLines.length})</h3>
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="max-w-full truncate font-mono text-xs">
                      {line.path.length > 50 ? `${line.path.substring(0, 50)}...` : line.path}
                    </div>
                  </div>
                  <Button
                    variant="ghost"
