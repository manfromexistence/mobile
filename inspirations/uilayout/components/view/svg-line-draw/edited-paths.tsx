...
import { type SavedPath, useSavedEditedPathsStore } from "@/store/use-saved-edited-paths";
...
export function SavedEditedPathsTab({
  ...
  const { savedEditedPaths, deleteEditedPath, clearAllEditedPaths } = useSavedEditedPathsStore();
