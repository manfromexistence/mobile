...
import { Matrix, pulse, snake, wave, type Frame } from "@/registry/elevenlabs-ui/ui/matrix";
...
const Example = () => {
  ...
  const unifiedPatterns = mode === "unified" ? createUnifiedPattern(unifiedFrame) : [];

  const expandedPatterns = mode === "expand" ? createExpandedLogo(expandProgress) : [];
  const collapsePatterns = mode === "collapse" ? createCollapseEffect(collapseProgress) : [];
