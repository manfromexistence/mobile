...
const SpeechInputContext = React.createContext<SpeechInputContextValue | null>(null);
...
const SpeechInput = React.forwardRef<HTMLDivElement, SpeechInputProps>(function SpeechInput(
  {
    children,
    getToken,
    onChange,
 ...
 */
const SpeechInputRecordButton = React.forwardRef<HTMLButtonElement, SpeechInputRecordButtonProps>(
      ...
      >
        <Skeleton
          className={cn(
            ...
            speechInput.isConnecting ? "bg-primary scale-90" : "scale-[60%] bg-transparent",
          )}
        />
        <SquareIcon
          className={cn(
 ...
 */
const SpeechInputPreview = React.forwardRef<HTMLDivElement, SpeechInputPreviewProps>(
  function SpeechInputPreview({ className, placeholder = "Listening...", ...props }, ref) {
    const speechInput = useSpeechInput();
 ...
 * Only visible when actively recording.
 */
const SpeechInputCancelButton = React.forwardRef<HTMLButtonElement, SpeechInputCancelButtonProps>(
