...
import { ToggleGroup, ToggleGroupItem } from "@/registry/elevenlabs-ui/ui/toggle-group";
...
function BlockViewerProvider({
  ...
  const value = React.useMemo(
    ...
    [item, view, resizablePanelRef, activeFile, tree, highlightedFiles, iframeKey],
  );
    ...
    <div className="hidden w-full items-center gap-2 pl-2 md:pr-6 lg:flex">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <Button
          ...
          size="sm"
          onClick={() => {
            copyToClipboard(`npx @elevenlabs/cli@latest components add ${item.name}`);
          }}
        >
