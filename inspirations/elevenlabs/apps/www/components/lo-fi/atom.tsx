...
const atomVariants = cva("inline-flex rounded-lg border-neutral-300 dark:border-neutral-600", {
  variants: {
    shade: {
...
function Atom({
  ...
  return <div data-slot="button" className={cn(atomVariants({ shade, className }))} {...props} />;
}
