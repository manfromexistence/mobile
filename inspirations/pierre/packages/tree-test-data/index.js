 ...
 */
function createWorkload(name, label, files, expandedFolders, rootCount, filesArePresorted = false) {
...
const workloadsByName = {
  ...
  linux: createWorkload("linux", "Linux fixture", linuxFiles, linuxFixture.folders, 1, true),
...
export function getVirtualizationWorkload(workloadName) {
  ...
  return workloadsByName[/** @type {VirtualizationWorkloadName} */ (workloadName)];
}
