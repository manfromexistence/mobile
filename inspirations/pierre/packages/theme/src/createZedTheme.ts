...
function makeZedTheme(name: string, appearance: "light" | "dark", c: Roles): ZedTheme {
  ...
  return {
    ...
    style: {
      ...
      players: [
        {
          cursor: c.accent.primary,
          background: c.accent.primary,
          selection: alpha(c.accent.primary, 0.25),
        },
        {
          cursor: c.states.success,
          background: c.states.success,
          selection: alpha(c.states.success, 0.25),
        },
        {
          cursor: c.syntax.keyword,
          background: c.syntax.keyword,
          selection: alpha(c.syntax.keyword, 0.25),
        },
        {
          cursor: c.syntax.func,
          background: c.syntax.func,
          selection: alpha(c.syntax.func, 0.25),
        },
        {
          cursor: c.syntax.string,
          background: c.syntax.string,
          selection: alpha(c.syntax.string, 0.25),
        },
        {
          cursor: c.states.warn,
          background: c.states.warn,
          selection: alpha(c.states.warn, 0.25),
        },
        {
          cursor: c.syntax.type,
          background: c.syntax.type,
          selection: alpha(c.syntax.type, 0.25),
        },
        {
          cursor: c.states.info,
          background: c.states.info,
          selection: alpha(c.states.info, 0.25),
        },
      ],
