...
export function createTheme({
  ...
  type: kind,
  roles: c,
}: CreateThemeOptions): VSCodeTheme {
  return {
    name,
    displayName,
    type: kind,
    colors: {
      ...
      // Editor chrome
      "editor.selectionBackground": alpha(c.accent.primary, kind === "dark" ? 0.3 : 0.18),
      ...
      // Merge conflicts
      "merge.currentHeaderBackground": alpha(c.states.merge, kind === "dark" ? 0.3 : 0.2),
      "merge.currentContentBackground": alpha(c.states.merge, kind === "dark" ? 0.12 : 0.08),
      "merge.incomingHeaderBackground": alpha(c.states.info, kind === "dark" ? 0.3 : 0.2),
    ...
    tokenColors: [
      ...
      // ========================================
      {
        ...
        settings: { foreground: c.syntax.comment },
      },
      {
      ...
      // ========================================
      {
        ...
        settings: { foreground: c.syntax.string },
      },
      {
      ...
      { scope: "keyword.control", settings: { foreground: c.syntax.keyword } },
      {
        ...
        settings: { foreground: c.syntax.keyword },
      },
      ...
      // ========================================
      {
        ...
        settings: { foreground: c.syntax.variable },
      },
      {
        scope: [
      ...
      },
      {
        ...
        settings: { foreground: c.syntax.parameter },
      },
      {
      ...
      // ========================================
      {
        ...
        settings: { foreground: c.syntax.func },
      },
      {
      ...
      // ========================================
      {
        ...
        settings: { foreground: c.syntax.type },
      },
      {
      ...
      },
      {
        ...
        settings: { foreground: c.syntax.operator },
      },
      {
        scope: [
      ...
      // ========================================
      {
        ...
        settings: { foreground: c.syntax.decorator },
      },
      {
      ...
      // ========================================
      {
        ...
        settings: { foreground: c.syntax.tag },
      },
      {
      ...
      },
      {
        ...
        settings: { foreground: c.syntax.invalid },
      },
      ...
      },
      {
        ...
        settings: { foreground: c.syntax.attribute, fontStyle: "normal" },
      },
      {
        scope: "entity.other.attribute-name.id",
        settings: { foreground: c.syntax.func, fontStyle: "normal" },
      },
      {
        scope: [
...

      {
        ...
        settings: { foreground: c.syntax.keyword, fontStyle: "italic" },
      },
      ...
      },
      {
        ...
        settings: { foreground: c.syntax.escape },
      },
