...
const sym_zip = `<symbol id="file-tree-builtin-zip" viewBox="0 0 16 16">
...
const BUILT_IN_FILE_EXTENSION_TOKENS: Partial<Record<string, BuiltInFileIconToken>> = {
  "7z": "zip",
  astro: "astro",
  AUTHORS: "text",
  avif: "image",
...
const COMPLETE_EXTENSION_OVERRIDES: Partial<Record<string, BuiltInFileIconToken>> = {
  jsx: "react",
  sass: "sass",
  scss: "sass",
  tsx: "react",
...
export function getBuiltInSpriteSheet(set: FileTreeBuiltInIconSet | "none"): string {
