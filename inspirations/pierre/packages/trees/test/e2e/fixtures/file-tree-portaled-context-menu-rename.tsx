...
type PortaledRenameContext = Pick<ContextMenuOpenContext, "anchorRect" | "close" | "restoreFocus">;
...
const renderPortaledContextMenu = (
  ...
  renameButton.addEventListener("click", () => {
    ...
    appendLog(started ? `rename:start ${item.path}` : `rename:unavailable ${item.path}`);
    queueMicrotask(() => {
      context.close();
