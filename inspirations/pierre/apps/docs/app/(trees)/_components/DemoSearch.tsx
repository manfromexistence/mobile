...
function createSearchPreloadedData(mode: FileTreeSearchMode, id: string, viewportHeight: number) {
...
export function DemoSearch() {
  return (
    <DemoSearchClient
      preloadedDataById={{
        "file-tree-search-demo-collapse-non-matches": collapseNonMatchesPreloadedData,
