...
const compactPreloadedData = preloadFileTree({
  ...
  initialVisibleRowCount:
    TREE_NEW_VIEWPORT_HEIGHTS.densityCompact / FILE_TREE_DENSITY_PRESETS.compact.itemHeight,
});
...
const defaultPreloadedData = preloadFileTree({
  ...
  paths: sampleFileList,
  initialVisibleRowCount:
    TREE_NEW_VIEWPORT_HEIGHTS.densityDefault / FILE_TREE_DENSITY_PRESETS.default.itemHeight,
});
...
const relaxedPreloadedData = preloadFileTree({
  ...
  paths: sampleFileList,
  initialVisibleRowCount:
    TREE_NEW_VIEWPORT_HEIGHTS.densityRelaxed / FILE_TREE_DENSITY_PRESETS.relaxed.itemHeight,
});
