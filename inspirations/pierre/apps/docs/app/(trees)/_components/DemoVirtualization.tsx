...
function createVirtualizationDemoData(): {
  ...
  for (const packageName of PACKAGE_NAMES) {
    ...
    paths.push(`${basePath}/package.json`, `${basePath}/tsconfig.json`, `${basePath}/README.md`);
  ...
  for (const appName of APP_NAMES) {
    ...
    for (const pageName of ["Home", "Settings", "Dashboard", "Profile", "Login", "NotFound"]) {
      paths.push(`${basePath}/src/pages/${pageName}.tsx`);
    }
    for (const hookName of ["useAuth", "useTheme", "useMedia", "useDebounce", "useForm"]) {
