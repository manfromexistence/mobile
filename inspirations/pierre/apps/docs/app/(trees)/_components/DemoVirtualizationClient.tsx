  ...
  return (
    <TreeExampleSection>
      <FeatureHeader
        ...
        description={
          <>
            Trees with tens of thousands of items render instantly with built-in and automatic
            virtualization. Only visible rows are mounted. The tree below contains{" "}
            <strong>{FILE_COUNT_FORMATTER.format(paths.length)} files</strong> with every folder
            expanded. Shown with <code>stickyFolders</code> enabled.
          </>
        }
      />
