...
function lightTheme(): CSSProperties {
  return {
    ...
    ["--trees-selected-focused-border-color-override" as string]: "oklch(55% 0.2 250)",
...
function darkTheme(): CSSProperties {
  return {
    ...
    ["--trees-selected-focused-border-color-override" as string]: "oklch(75% 0.2 250)",
...
function synthwaveTheme(): CSSProperties {
  return {
    ...
    ["--trees-selected-border-color-override" as string]: "oklch(66.3% 0.26 348)",
    ["--trees-selected-focused-border-color-override" as string]: "oklch(76.9% 0.19 339)",
...
const THEME_SWATCH_COLORS: Record<StylingMobileView, readonly string[]> = {
  light: ["oklch(98.5% 0 0)", "oklch(92% 0.06 250)", "oklch(65% 0.15 250)", "oklch(20% 0.08 250)"],
  dark: ["oklch(20.5% 0 0)", "oklch(35% 0.08 250)", "oklch(65% 0.2 250)", "oklch(97% 0.04 250)"],
  synthwave: [
    "oklch(27.2% 0.05 302)",
    "oklch(66.3% 0.26 348)",
    "oklch(76.9% 0.19 339)",
  ...
  return (
    <span
      ...
      className={[
        ...
        isActive ? "" : "grayscale group-hover:grayscale-0 opacity-50 group-hover:opacity-100",
      ]
        .filter(Boolean)
        .join(" ")}
...
export function DemoStylingClient({ preloadedData, selectedPaths }: DemoStylingClientProps) {
    ...
    <TreeExampleSection>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className={hiddenOnMobileUnless("light")}>
          ...
          />
          <TreeCssViewer contents={styleObjectToCss(lightThemeStyles)} filename="light-theme.css" />
        </div>
        <div className={hiddenOnMobileUnless("dark")}>
          ...
          />
          <TreeCssViewer contents={styleObjectToCss(darkThemeStyles)} filename="dark-theme.css" />
        </div>
      ...
      <IconFootnote icon={<IconBulbFill />}>
        ...
        here—a modern color space that allows for more uniform colors and more consistent palettes.
      </IconFootnote>
    </TreeExampleSection>
  );
}
