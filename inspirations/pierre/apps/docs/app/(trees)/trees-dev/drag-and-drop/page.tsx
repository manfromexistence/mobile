...
const DRAG_AND_DROP_PREPARED_INPUT = createPresortedPreparedInput(DRAG_AND_DROP_DEMO_PATHS);
...
export default async function TreesDevDragAndDropPage() {
  ...
  const sharedOptions: Omit<FileTreePathOptions, "dragAndDrop" | "id" | "preparedInput"> = {
    composition: {
      header: {
