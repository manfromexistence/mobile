import { type FileTreeOptions, preparePresortedFileTreeInput } from "@pierre/trees";
...
export function createPresortedPreparedInput(paths: readonly string[]): FileTreePreparedInput {
