...
export function resolveWorkloadName(value: string | null | undefined): TreesWorkloadName {
...
export function getRequestedWorkloadName(
  ...
  return resolveWorkloadName(getRequestedSearchParamValue(searchParams?.workload));
}
...
export function getRequestedExpansionMode(
  ...
  return expansionMode === "all" || expansionMode === "collapsed" ? expansionMode : "workload";
}

export function getWorkloadOption(workloadName: TreesWorkloadName): TreesWorkloadOption {
  return (
