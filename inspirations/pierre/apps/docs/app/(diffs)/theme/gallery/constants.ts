...
export const GRID_CLASSES: Record<ViewMode, string> = {
  trees: "grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6",
...
export const INITIAL_EXPANDED_ITEMS = ["build", "build/assets", "src", "src/components"];
