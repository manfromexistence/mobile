...
export function ShikiThemes({ prerenderedDiff: { options, ...props } }: ShikiThemesProps) {
  useEffect(() => {
    void preloadHighlighter({
      themes: ["ayu-dark", "catppuccin-mocha", "dark-plus", "github-dark", "vitesse-dark"],
      langs: [],
    });
  }, []);
  ...
  const [selectedColorMode, setSelectedColorMode] = useState<"system" | "light" | "dark">("system");
  ...
  return (
    <div className="space-y-5">
      <FeatureHeader
        ...
        description={
          <>
            We built <code>@pierre/diffs</code> on top of Shiki for syntax highlighting and general
            theming. Our components automatically adapt to blend in with your theme selection,
            including across color modes.
          </>
        }
      />
      <div className="flex flex-wrap gap-3 md:items-center">
        ...
        <ButtonGroup
          ...
          onValueChange={(value) => setSelectedColorMode(value as "system" | "light" | "dark")}
        >
