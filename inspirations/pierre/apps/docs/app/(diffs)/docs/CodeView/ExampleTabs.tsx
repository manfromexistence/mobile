...
export function CodeViewExampleTabs({ reactExample, vanillaExample }: CodeViewExampleTabsProps) {
  const [mode, setMode] = useState<CodeViewExampleMode>("react");

  return (
    <>
      <ButtonGroup value={mode} onValueChange={(value) => setMode(value as CodeViewExampleMode)}>
