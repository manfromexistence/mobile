...
export function SSRPage({ preloadedFileDiff }: SSRPageProps) {
  ...
  const [lineAnnotations, setLineAnnotations] = useState<DiffLineAnnotation<AnnotationMetadata>[]>(
  ...
  return (
    ...
    >
      ...
      <h1 className="py-8 text-3xl font-medium tracking-tight md:text-4xl">SSR Demos</h1>
      ...
      <div className="flex flex-col gap-20">
        ...
        <div>
          <div className="flex justify-between">
            <h2 className="text-2xl font-medium tracking-tight md:text-2xl">Interactive Test</h2>
            <button
