...
const NavLink = ({ href, children, icon, external = false, active, className }: NavLinkProps) => {
  ...
  if (external || href[0] === "#") {
    return (
      ...
      >
        {icon != null && <span className="flex h-4 w-4 items-center justify-center">{icon}</span>}
