...
export function getGutterSize(className: string): ScrollbarGutterSize | undefined {
 ...
 */
export function detectGutterSize(className: string, ignoreCache = false): ScrollbarGutterSize {
