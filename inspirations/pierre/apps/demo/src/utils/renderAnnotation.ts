...
function renderDOM(metadata: LineCommentMetadata, lineNumber: number, side: string = "line") {
...
export function renderAnnotation(annotation: LineAnnotation<LineCommentMetadata>): HTMLElement {
