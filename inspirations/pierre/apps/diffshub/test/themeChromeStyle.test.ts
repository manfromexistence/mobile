...
describe("buildAnnotationThemeStyle", () => {
  test("scopes inline comment theming without changing code-view chrome tokens", () => {
    const themeChromeStyle = {
      ...
      "--diffshub-annotation-border": "color-mix(in srgb, #f8fafc 18%, #101010)",
      "--diffshub-annotation-fg": "#f8fafc",
      "--diffshub-annotation-hover-border": "color-mix(in srgb, #f8fafc 28%, #101010)",
      "--diffshub-annotation-shadow": "0 18px 44px color-mix(in srgb, #101010 72%, transparent)",
