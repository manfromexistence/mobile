...
const LIGHT_SOFT_CHROME: Record<string, string> = {
  ...
  "--diffshub-popover-shadow": "0 8px 16px rgb(0 0 0 / 0.07), 0 2px 4px rgb(0 0 0 / 0.05)",
  ...
  "--diffshub-annotation-hover-border": "color-mix(in srgb, #737373 28%, #f7f7f7)",
  "--diffshub-annotation-shadow": "0 8px 16px rgb(0 0 0 / 0.07), 0 2px 4px rgb(0 0 0 / 0.05)",
...
const DARK_SOFT_CHROME: Record<string, string> = {
  ...
  "--diffshub-annotation-hover-border": "color-mix(in srgb, #8a8a8a 28%, #101010)",
  "--diffshub-annotation-shadow": "0 8px 16px rgb(0 0 0 / 0.07), 0 2px 4px rgb(0 0 0 / 0.05)",
...
describe("chromeThemeProps + diffshubChromeMapping", () => {
  ...
  test("returns an empty style when no theme is resolved yet", () => {
    expect(
      chromeThemeProps({ theme: undefined, colorScheme: "light" }, diffshubChromeMapping).style,
    ).toEqual({});
  });
});
