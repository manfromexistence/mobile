        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button
                data-component="cli-row"
                onClick={handleCopyClick("brew install anomalyco/tap/opencode")}
              >
                <code>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("brew install --cask opencode-desktop")}
              >
                <code>
              ...
              <div data-component="download-row">
                ...
                <a
                  href={language.route(getDownloadHref("darwin-aarch64-dmg"))}
              ...
              <div data-component="download-row">
                ...
                <a
                  href={language.route(getDownloadHref("darwin-x64-dmg"))}
                  data-component="action-button"
                >
                  {i18n.t("download.action.download")}
                </a>
              ...
              <div data-component="download-row">
                ...
                <a
                  href={language.route(getDownloadHref("linux-x64-deb"))}
                  data-component="action-button"
                >
                  {i18n.t("download.action.download")}
                </a>
              ...
              <div data-component="download-row">
                ...
                <a
                  href={language.route(getDownloadHref("linux-x64-rpm"))}
                  data-component="action-button"
                >
                  {i18n.t("download.action.download")}
                </a>
            ...
            <li>
              <Faq question={i18n.t("home.faq.q7")}>
                ...
                <a href={language.route("/docs/share/#privacy")}>
                  {i18n.t("download.faq.a6.shareLink")}
                </a>
                .
              </Faq>
            </li>
