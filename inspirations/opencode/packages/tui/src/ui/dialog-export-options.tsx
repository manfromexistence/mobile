    ...
    bindings: [
      {
        ...
        cmd: () => {
          const order: Array<
            "filename" | "thinking" | "toolDetails" | "assistantMetadata" | "openWithoutSaving"
          > = ["filename", "thinking", "toolDetails", "assistantMetadata", "openWithoutSaving"];
    ...
    bindings: [
      {
        ...
        cmd: () => {
          ...
          if (store.active === "assistantMetadata")
            setStore("assistantMetadata", !store.assistantMetadata);
          if (store.active === "openWithoutSaving")
    ...
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <box flexDirection="column">
        ...
        <box
          ...
          paddingLeft={1}
          backgroundColor={
            store.active === "assistantMetadata" ? theme.backgroundElement : undefined
          }
        ...
        <box
          ...
          paddingLeft={1}
          backgroundColor={
            store.active === "openWithoutSaving" ? theme.backgroundElement : undefined
          }
      ...
      <Show when={store.active === "filename"}>
        <text fg={theme.textMuted} paddingBottom={1}>
          Press <span style={{ fg: theme.text }}>return</span> to confirm,{" "}
          <span style={{ fg: theme.text }}>tab</span> for options
        </text>
      </Show>
    </box>
  );
