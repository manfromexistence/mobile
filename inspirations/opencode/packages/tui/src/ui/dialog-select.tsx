  ...
  function FooterAction(action: { item: VisibleAction }) {
    ...
    return (
      ...
      >
        ...
        <text fg={disabled() ? theme.textMuted : active() ? fg : theme.textMuted}>
          {" "}
          {item.label}
        </text>
      </box>
                  ...
                  <For each={options}>
                    {(option) => {
                      const active = createMemo(
                        () => !props.locked && isDeepEqual(option.value, selected()?.value),
                      );
                        ...
                        >
                          ...
                          >
                            ...
                            <Option
                              ...
                              footer={
                                flatten() ? (option.category ?? option.footer) : option.footer
                              }
