...
const Endpoint1_0 = (raw: RawClient["server.location"]) => (input?: Endpoint1_0Input) =>
  raw["location.get"]({ query: { location: input?.["location"] } }).pipe(
...
const Endpoint2_0 = (raw: RawClient["server.agent"]) => (input?: Endpoint2_0Input) =>
  raw["agent.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint3_10 = (raw: RawClient["server.session"]) => (input: Endpoint3_10Input) =>
  raw["session.revert.clear"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint3_11 = (raw: RawClient["server.session"]) => (input: Endpoint3_11Input) =>
  raw["session.revert.commit"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint3_15 = (raw: RawClient["server.session"]) => (input: Endpoint3_15Input) =>
  raw["session.interrupt"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint5_0 = (raw: RawClient["server.model"]) => (input?: Endpoint5_0Input) =>
  raw["model.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint6_0 = (raw: RawClient["server.provider"]) => (input?: Endpoint6_0Input) =>
  raw["provider.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint7_0 = (raw: RawClient["server.integration"]) => (input?: Endpoint7_0Input) =>
  raw["integration.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
type Endpoint7_3Request = Parameters<
  RawClient["server.integration"]["integration.connect.oauth"]
>[0];
...
type Endpoint7_4Request = Parameters<
  RawClient["server.integration"]["integration.attempt.status"]
>[0];
...
type Endpoint7_5Request = Parameters<
  RawClient["server.integration"]["integration.attempt.complete"]
>[0];
...
type Endpoint7_6Request = Parameters<
  RawClient["server.integration"]["integration.attempt.cancel"]
>[0];
...
const Endpoint9_2 = (raw: RawClient["server.permission"]) => (input: Endpoint9_2Input) =>
  raw["permission.saved.remove"]({ params: { id: input["id"] } }).pipe(
    Effect.mapError(mapClientError),
  );

type Endpoint9_3Request = Parameters<
  RawClient["server.permission"]["session.permission.create"]
>[0];
...
const Endpoint11_0 = (raw: RawClient["server.command"]) => (input?: Endpoint11_0Input) =>
  raw["command.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint12_0 = (raw: RawClient["server.skill"]) => (input?: Endpoint12_0Input) =>
  raw["skill.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint14_0 = (raw: RawClient["server.pty"]) => (input?: Endpoint14_0Input) =>
  raw["pty.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint15_0 = (raw: RawClient["server.question"]) => (input?: Endpoint15_0Input) =>
  raw["question.request.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
...
const Endpoint16_0 = (raw: RawClient["server.reference"]) => (input?: Endpoint16_0Input) =>
  raw["reference.list"]({ query: { location: input?.["location"] } }).pipe(
    Effect.mapError(mapClientError),
  );
