...
const config = Config.all({
  ...
  migrationsDir: Config.nonEmptyString("DATABASE_MIGRATIONS_DIR").pipe(
...
export class DrizzleClient extends Context.Service<DrizzleClient, Drizzle>()(
...
export const layer = Layer.mergeAll(
  ...
  DrizzleClient.layer.pipe(Layer.provide(DatabaseConfig.layer)),
);
