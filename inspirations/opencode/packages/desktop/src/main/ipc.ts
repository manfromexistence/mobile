...
export function registerIpcHandlers(deps: Deps) {
  ...
  ipcMain.handle(
    ...
    (_event: IpcMainInvokeEvent, error: FatalRendererError) => deps.recordFatalRendererError(error),
  );
  ...
  ipcMain.handle(
    "read-picked-file",
    async (event: IpcMainInvokeEvent, token: string, filePath: string) => {
  ...
  ipcMain.handle(
    ...
    (event: IpcMainInvokeEvent, action: DesktopMenuAction) => {
