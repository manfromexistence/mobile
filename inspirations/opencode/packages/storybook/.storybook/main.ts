    ...
    return mergeConfig(config, {
      ...
      resolve: {
        ...
        alias: [
          ...
          {
            find: /^@\/context\/prompt$/,
            replacement: path.resolve(mocks, "app/context/prompt.ts"),
          },
          {
            find: /^@\/context\/layout$/,
            replacement: path.resolve(mocks, "app/context/layout.ts"),
          },
          ...
          { find: /^@\/context\/sync$/, replacement: path.resolve(mocks, "app/context/sync.ts") },
          {
            ...
            replacement: path.resolve(mocks, "app/context/comments.ts"),
          },
          {
            find: /^@\/context\/command$/,
            replacement: path.resolve(mocks, "app/context/command.ts"),
          },
          {
            find: /^@\/context\/permission$/,
            replacement: path.resolve(mocks, "app/context/permission.ts"),
          },
          {
            find: /^@\/context\/language$/,
            replacement: path.resolve(mocks, "app/context/language.ts"),
          },
          {
            find: /^@\/context\/platform$/,
            replacement: path.resolve(mocks, "app/context/platform.ts"),
          },
          {
            find: /^@\/context\/global-sync$/,
            replacement: path.resolve(mocks, "app/context/global-sync.ts"),
          },
          {
            find: /^@\/hooks\/use-providers$/,
