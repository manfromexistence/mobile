...
export const TuiAttentionSoundNames = [
  "default",
  "question",
  "permission",
  "error",
...
type TuiBindingLookupView = {
  ...
  ) => ReadonlyArray<Binding<Renderable, KeyEvent>>;
...
type TuiSlotShape<
  Name extends string,
  Slots extends Record<string, object>,
> = Name extends keyof TuiHostSlotMap
  ? TuiHostSlotMap[Name]
...
type SlotCore<Slots extends Record<string, object> = {}> = SolidPlugin<
  TuiSlotMap<Slots>,
  TuiSlotContext
>;

export type TuiSlotPlugin<Slots extends Record<string, object> = {}> = Omit<
  SlotCore<Slots>,
  "id"
> & {
  id?: never;
