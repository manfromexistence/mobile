...
export interface Interface {
  ...
  readonly attach: (
    id: PtyID,
    input: AttachInput,
  ) => Effect.Effect<Attachment, NotFoundError | ExitedError>;
}
...
export const node = makeLocationNode({
  service: Service,
  layer,
  deps: [EventV2.node, Location.node, Config.node],
});
