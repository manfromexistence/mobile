...
export class TargetExistsError extends Schema.TaggedErrorClass<TargetExistsError>()(
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const writeTextPreservingBom = Effect.fn("FileMutation.writeTextPreservingBom")(
      (input: TextWriteInput) =>
        withTargetLock(input.target)(
          Effect.gen(function* () {
    ...
    const writeIfUnchanged = Effect.fn("FileMutation.writeIfUnchanged")(
      (input: ConditionalWriteInput) =>
        withTargetLock(input.target)(
          Effect.gen(function* () {
