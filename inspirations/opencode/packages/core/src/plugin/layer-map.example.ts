...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()(
  "@opencode/example/ConfigServiceMap",
  {
    lookup: (context: RequestContext) =>
      configServiceLayer.pipe(
        Layer.provide(Layer.succeed(RequestContextRef, RequestContextRef.of(context))),
      ),
...
export const handleRequest = Effect.fn("LayerMapExample.handleRequest")(function* (
