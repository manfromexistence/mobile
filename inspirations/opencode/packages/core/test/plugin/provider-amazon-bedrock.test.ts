...
function openAIUrl(language: unknown, path: string, modelId: string) {
  return (
    language as { config: { url: (input: { path: string; modelId: string }) => string } }
  ).config.url({
    path,
    modelId,
  });
...
describe("AmazonBedrockPlugin", () => {
  ...
  it.effect(
    "creates SDK without explicit credential env so the default AWS chain can resolve credentials",
    () =>
      withEnv(
        {
        ...
        () =>
          Effect.gen(function* () {
            ...
            expect(bedrockBaseURL(result.sdk)).toBe(
  ...
  it.effect("loads bearer token option into env and uses bearer auth", () =>
    withEnv(
      { AWS_ACCESS_KEY_ID: undefined, AWS_BEARER_TOKEN_BEDROCK: undefined, AWS_PROFILE: undefined },
      () =>
        Effect.gen(function* () {
          const plugin = yield* PluginV2.Service;
          const aisdk = yield* AISDK.Service;
          ...
          yield* Effect.promise(() =>
            bedrockFetch(result.sdk)("https://bedrock.example", { method: "POST" }),
          );
      ...
      const cases = [
        {
          ...
          expected: "us.amazon.nova-micro-v1:0",
        },
        {
          region: "us-east-1",
        ...
        },
        {
          ...
          expected: "us.amazon.nova-premier-v1:0",
        },
        {
          region: "us-east-1",
          modelID: "amazon.nova-2-lite-v1:0",
          expected: "us.amazon.nova-2-lite-v1:0",
        },
        {
          region: "us-east-1",
          modelID: "anthropic.claude-sonnet-4-5",
          expected: "us.anthropic.claude-sonnet-4-5",
        },
        ...
        },
        {
          ...
          expected: "cohere.command-r-plus-v1:0",
        },
        {
          region: "eu-west-1",
          modelID: "anthropic.claude-sonnet-4-5",
          expected: "eu.anthropic.claude-sonnet-4-5",
        },
        {
          region: "eu-west-2",
          modelID: "amazon.nova-lite-v1:0",
        ...
        },
        {
          region: "eu-west-3",
          modelID: "amazon.nova-micro-v1:0",
          expected: "eu.amazon.nova-micro-v1:0",
        },
        {
          region: "eu-north-1",
        ...
        {
          region: "eu-central-1",
          modelID: "mistral.pixtral-large-v1:0",
          expected: "eu.mistral.pixtral-large-v1:0",
        },
        {
          region: "eu-south-1",
          modelID: "anthropic.claude-sonnet-4-5",
        ...
        },
        {
          ...
          expected: "apac.anthropic.claude-opus-4",
        },
        {
        ...
        },
        {
          region: "ap-northeast-1",
          modelID: "amazon.nova-pro-v1:0",
          expected: "jp.amazon.nova-pro-v1:0",
        },
        {
          region: "ap-south-1",
          modelID: "anthropic.claude-sonnet-4-5",
        ...
        },
        {
          region: "ap-south-1",
          modelID: "amazon.nova-lite-v1:0",
          expected: "apac.amazon.nova-lite-v1:0",
        },
        {
          region: "ca-central-1",
          modelID: "anthropic.claude-sonnet-4-5",
