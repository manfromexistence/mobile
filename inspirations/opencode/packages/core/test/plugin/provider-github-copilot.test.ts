    ...
    Effect.gen(function* () {
      ...
      yield* aisdk.runLanguage({
        model: ModelV2.Info.make({
          ...
          api: {
            id: ModelV2.ID.make("gpt-5-mini-2025-08-07"),
            type: "aisdk",
    ...
    Effect.gen(function* () {
      ...
      yield* aisdk.runLanguage({
        model: ModelV2.Info.make({
          ...ModelV2.Info.empty(
            ProviderV2.ID.make("github-copilot"),
            ModelV2.ID.make("mai-code-1-flash-picker"),
          ),
          api: {
  ...
  it.effect("does not disable gpt-5-chat-latest for non-Copilot providers", () =>
    Effect.gen(function* () {
      ...
      yield* catalog.transform((catalog) => {
        ...
        catalog.model.update(
          ProviderV2.ID.make("custom-copilot"),
          ModelV2.ID.make("gpt-5-chat-latest"),
          () => {},
        );
      });
