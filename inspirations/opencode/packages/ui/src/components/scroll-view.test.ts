...
describe("scrollKey", () => {
  test("maps plain navigation keys", () => {
    ...
    expect(
      scrollKey({ key: "ArrowUp", altKey: false, ctrlKey: false, metaKey: false, shiftKey: false }),
    ).toBe("up");
  });
  ...
  test("ignores modified keybinds", () => {
    ...
    expect(
      scrollKey({ key: "PageUp", altKey: false, ctrlKey: true, metaKey: false, shiftKey: false }),
    ).toBeUndefined();
    expect(
      scrollKey({ key: "End", altKey: false, ctrlKey: false, metaKey: false, shiftKey: true }),
    ).toBeUndefined();
  });

  test("maps space and shift-space directions", () => {
    expect(
      scrollKey({ key: " ", altKey: false, ctrlKey: false, metaKey: false, shiftKey: false }),
    ).toBe("page-down");
    expect(
      scrollKey({ key: " ", altKey: false, ctrlKey: false, metaKey: false, shiftKey: true }),
    ).toBe("page-up");
  });
});
