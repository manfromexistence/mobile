...
export const withOpenAIOptions = <
  Options extends { readonly providerOptions?: OpenAIProviderOptionsInput },
>(
  modelID: string,
  options: Options,
  ...
  return {
    ...
    providerOptions: mergeProviderOptions(
      openAIDefaultOptions(modelID, defaults),
