...
export function formatSelectedLineLabel(
  range: LineSpan,
  t: (key: SelectionKey, params: SelectionVars) => string,
) {
...
export function lineInSelectedRange(
  range: SelectedLineRange | null | undefined,
  line: number,
  side?: Side,
) {
