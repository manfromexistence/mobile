...
export async function startVisualStabilityProbe(
  page: Page,
  regions: Record<string, VisualRegionDefinition>,
) {
...
export async function expectVisualStability(
  ...
  await reportVisualStability(
    ...
    name,
    {
      ...trace,
      frames:
        (trace as VisualStabilityTrace & { [capturedFrames]?: CapturedFrame[] })[capturedFrames] ??
        [],
    },
