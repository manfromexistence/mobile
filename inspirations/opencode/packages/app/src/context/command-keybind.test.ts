...
describe("command keybind helpers", () => {
  ...
  test("matchKeybind normalizes punctuation keys", () => {
    ...
    expect(matchKeybind(keybinds, new KeyboardEvent("keydown", { key: ",", ctrlKey: true }))).toBe(
      true,
    );
    expect(matchKeybind(keybinds, new KeyboardEvent("keydown", { key: "+", shiftKey: true }))).toBe(
      true,
    );
    expect(matchKeybind(keybinds, new KeyboardEvent("keydown", { key: " ", metaKey: true }))).toBe(
      true,
    );
    expect(
      matchKeybind(
