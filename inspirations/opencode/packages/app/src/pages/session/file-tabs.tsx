...
} from "@opencode-ai/session-ui/pierre/selection-bridge";
...
export function FileTabContent(props: { tab: string }) {
  ...
  const updateCommentInContext = (input: {
    ...
    const preview =
      input.file === path()
        ? buildPreview(input.file, selectionFromLines(input.selection))
        : undefined;
  ...
  createEffect(() => {
    ...
    const restore =
      (loaded && !prev.loaded) || (ready && !prev.ready) || (active && loaded && !prev.active);
