...
export function SessionFileListV2(props: {
  ...
  createEffect(() => {
    ...
    if (!rootRef) return;
    queueMicrotask(() => {
      const row = rootRef?.querySelector<HTMLElement>(
        '[data-slot="file-tree-v2-row"][data-highlighted]',
      );
          ...
          return (
            ...
            >
              ...
              <span class="flex min-w-0 flex-1 items-center overflow-hidden whitespace-nowrap">
                ...
                <span class="text-12-medium text-text-base truncate min-w-0 shrink-0">
                  {filename()}
                </span>
              </span>
              <Show when={kind()}>
