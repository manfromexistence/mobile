          ...
          {(_) => {
            ...
            const openNewTab = () => {
              ...
              if (route.type === "session" && activeSession) {
                tabs.newDraft(
                  { server: route.server ?? server.key, directory: activeSession.directory },
                  "",
                );
                return;
              }
                    ...
                    >
                      <div
                        ...
                        classList={{
                          ...
                          "opacity-0 duration-120 ease-in delay-0 pointer-events-none":
                  ...
                  >
                    <Show when={hasProjects() && nav()}>
                      <div class="flex items-center gap-0 transition-transform">
                        <Tooltip
                          placement="bottom"
                          value={language.t("common.goBack")}
                          openDelay={800}
                        >
                          <Button
                            variant="ghost"
                        ...
                        <Tooltip
                          placement="bottom"
                          value={language.t("common.goForward")}
                          openDelay={800}
                        >
                          <Button
                            variant="ghost"
