...
export class OauthMissing extends Schema.TaggedErrorClass<OauthMissing>()(
...
export class OauthCodeMissing extends Schema.TaggedErrorClass<OauthCodeMissing>()(
