...
export type RunCommand = NonNullable<
  Awaited<ReturnType<OpencodeClient["command"]["list"]>>["data"]
>[number];

export type RunProvider = NonNullable<
...
export type RunAgent = NonNullable<
  Awaited<ReturnType<OpencodeClient["app"]["agents"]>>["data"]
>[number];

type RunResourceMap = NonNullable<
  Awaited<ReturnType<OpencodeClient["experimental"]["resource"]["list"]>>["data"]
>;
