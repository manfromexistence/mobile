...
export type Interface = {
  ...
  readonly getVariant: (
    sessionId: string,
  ) => Effect.Effect<string | undefined, ACPError.SessionNotFoundError>;
  readonly setMode: (
    sessionId: string,
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const update = Effect.fn("ACP.Session.update")(function* (
      sessionId: string,
    ...
    const setVariant: Interface["setVariant"] = Effect.fn("ACP.Session.setVariant")(
      (sessionId, variant) => update(sessionId, (session) => ({ ...session, variant })),
    );
    ...
    const recordPartMetadata: Interface["recordPartMetadata"] = Effect.fn(
      "ACP.Session.recordPartMetadata",
    )((input) => {
      const metadata = {
