...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opencode.git")).toEqual({
    owner: "sst",
    repo: "opencode",
  });
});
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opencode")).toEqual({
    owner: "sst",
    repo: "opencode",
  });
});
...
test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opencode.git")).toEqual({
    owner: "sst",
    repo: "opencode",
  });
});
...
test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opencode")).toEqual({
    owner: "sst",
    repo: "opencode",
  });
});
...
test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opencode.git")).toEqual({
    owner: "sst",
    repo: "opencode",
  });
});
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opencode")).toEqual({
    owner: "sst",
    repo: "opencode",
  });
});
...
test("parses git protocol URLs from package metadata", () => {
  expect(parseGitHubRemote("git://github.com/facebook/react.git")).toEqual({
    owner: "facebook",
    repo: "react",
  });
  expect(parseGitHubRemote("git+https://github.com/facebook/react.git")).toEqual({
    owner: "facebook",
    repo: "react",
  });
  expect(parseGitHubRemote("git+ssh://git@github.com/facebook/react.git")).toEqual({
    owner: "facebook",
    repo: "react",
  });
});
...
test("parses URL with underscores in names", () => {
  expect(parseGitHubRemote("git@github.com:my_org/my_repo.git")).toEqual({
    owner: "my_org",
    repo: "my_repo",
  });
});
...
test("parses URL with numbers in names", () => {
  expect(parseGitHubRemote("https://github.com/org123/repo456")).toEqual({
    owner: "org123",
    repo: "repo456",
  });
});
