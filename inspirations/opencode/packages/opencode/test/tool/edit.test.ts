...
const fail = Effect.fn("EditToolTest.fail")(function* (
  args: Tool.InferParameters<typeof EditTool>,
) {
  ...
  describe("creating new files", () => {
    ...
    it.instance("rejects empty oldString on existing files and leaves content unchanged", () =>
      Effect.gen(function* () {
        ...
        expect(
          (yield* fail({ filePath: filepath, oldString: "", newString: "using Up;\n" })).message,
        ).toContain("oldString cannot be empty");
  ...
  describe("editing existing files", () => {
    ...
    it.instance("throws error when oldString equals newString", () =>
      Effect.gen(function* () {
        ...
        expect(
          (yield* fail({ filePath: filepath, oldString: "same", newString: "same" })).message,
        ).toContain("identical");
      }),
    );
    ...
    it.instance("throws error when oldString not found in file", () =>
      Effect.gen(function* () {
        ...
        expect(
          yield* fail({ filePath: filepath, oldString: "not in file", newString: "replacement" }),
  ...
  describe("edge cases", () => {
    ...
    it.instance("throws error when oldString equals newString", () =>
      Effect.gen(function* () {
        ...
        expect(
          (yield* fail({ filePath: filepath, oldString: "", newString: "" })).message,
        ).toContain("identical");
      }),
    );
    ...
    it.instance("throws error when path is directory", () =>
      Effect.gen(function* () {
        ...
        expect(
          (yield* fail({ filePath: dirpath, oldString: "old", newString: "new" })).message,
        ).toContain("directory");
      }),
    );
