...
export interface SegmentedInputProps extends EmptyProps<"div">, CompositionProps {
  /**
...
export interface SegmentedInputItemProps extends EmptyProps<"input">, CompositionProps {
  /**
