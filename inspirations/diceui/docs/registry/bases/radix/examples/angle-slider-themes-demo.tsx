...
const themes = [
  ...
  },
  {
    ...
    thumbClass: "border-green-500 bg-green-50 ring-green-500/50 dark:bg-green-950",
  ...
  },
  {
    ...
    thumbClass: "border-yellow-500 bg-yellow-50 ring-yellow-500/50 dark:bg-yellow-950",
  ...
  },
  {
    ...
    thumbClass: "border-purple-500 bg-purple-50 ring-purple-500/50 dark:bg-purple-950",
  ...
  },
  {
    ...
    thumbClass: "border-orange-500 bg-orange-50 ring-orange-500/50 dark:bg-orange-950",
...
function AngleSliderCard({ theme }: AngleSliderCardProps) {
  return (
    <div className="flex flex-col items-center gap-1">
      <AngleSlider defaultValue={[theme.value]} max={360} min={0} step={1} size={60}>
        ...
        <AngleSliderValue className={cn("font-semibold text-sm", theme.textClass)} />
      </AngleSlider>
