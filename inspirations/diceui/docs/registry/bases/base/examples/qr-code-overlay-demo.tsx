  ...
  return (
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-center text-muted-foreground text-sm">Canvas with Logo</p>
      </div>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-center text-muted-foreground text-sm">SVG with Logo</p>
      </div>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-center text-muted-foreground text-sm">Image with Logo</p>
      </div>
    </div>
  );
}
