...
interface ScrollSpyProps extends React.ComponentProps<"div">, useRender.ComponentProps<"div"> {
  value?: string;
  defaultValue?: string;
...
function ScrollSpy(props: ScrollSpyProps) {
  ...
  return (
    <StoreContext.Provider value={store}>
      <ScrollSpyContext.Provider value={contextValue}>{element}</ScrollSpyContext.Provider>
    </StoreContext.Provider>
  );
}

interface ScrollSpyNavProps extends React.ComponentProps<"nav">, useRender.ComponentProps<"nav"> {}
...
interface ScrollSpyLinkProps extends React.ComponentProps<"a">, useRender.ComponentProps<"a"> {
  value: string;
}
