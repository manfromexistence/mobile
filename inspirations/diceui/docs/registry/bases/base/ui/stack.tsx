...
interface StackProps extends React.ComponentProps<"div">, useRender.ComponentProps<"div"> {
  side?: Side;
  itemCount?: number;
  expandedItemCount?: number;
  gap?: number;
...
interface StackItemProps extends React.ComponentProps<"div">, useRender.ComponentProps<"div"> {}
