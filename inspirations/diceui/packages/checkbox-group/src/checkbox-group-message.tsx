...
interface CheckboxGroupMessageProps extends React.ComponentPropsWithoutRef<typeof Primitive.div> {
  /**
...
const CheckboxGroupMessage = React.forwardRef<HTMLDivElement, CheckboxGroupMessageProps>(
  (props, ref) => {
