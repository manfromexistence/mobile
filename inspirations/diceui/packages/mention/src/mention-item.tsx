...
const [MentionItemProvider, useMentionItemContext] = createContext<MentionItemContext>(ITEM_NAME);
...
const MentionItem = React.forwardRef<ItemElement, MentionItemProps>((props, forwardedRef) => {
    ...
    <MentionItemProvider label={label} value={value} disabled={isDisabled}>
      <Primitive.div
        ...
        onClick={composeEventHandlers(itemProps.onClick, () => {
          ...
          const lastTriggerIndex = inputElement.value.lastIndexOf(context.trigger, selectionStart);
