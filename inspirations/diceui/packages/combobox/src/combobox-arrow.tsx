...
const ComboboxArrow = React.forwardRef<SVGSVGElement, ComboboxArrowProps>((props, forwardedRef) => {
  ...
  return (
    ...
    >
      ...
      >
        {props.asChild ? props.children : <path d="M0 10 L15 0 L30 10" fill="currentColor" />}
      </Primitive.svg>
    </span>
  );
});
