...
const ComboboxInput = React.forwardRef<InputElement, ComboboxInputProps>((props, forwardedRef) => {
  ...
  }, [context.openOnFocus, context.open, context.readOnly, context.onOpenChange]);
