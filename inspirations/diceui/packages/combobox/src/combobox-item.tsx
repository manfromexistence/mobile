...
const ComboboxItem = React.forwardRef<ItemElement, ComboboxItemProps>((props, forwardedRef) => {
  ...
  }, [label, value, isDisabled, onSelect, groupContext?.id, context.onItemRegister]);
