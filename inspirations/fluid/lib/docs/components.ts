...
export const systemList: SystemEntry[] = [
  {
    slug: "surfaces",
    name: "Surfaces",
    description: "Eight-level surface and shadow ladder for elevation in light and dark mode.",
    isNew: true,
  },
  {
    slug: "scrollbars",
    name: "Scrollbars",
    description:
      "A scrollbar that stays out of the way but never disappears, over shadcn's scroll-fade baseline — restyled to the shape system, native scroll on touch.",
    isNew: true,
  },
  {
    slug: "motion",
    name: "Motion",
    description:
      "Spring tokens, faster exits, and reflow-free weight animation — the motion rules shared by every component.",
    isNew: true,
  },
];
...
export const componentList: ComponentEntry[] = [
  ...
  },
  {
    ...
    description:
      "Stepped question flow with single/multi-select, optional 'other' input, and skip.",
    isNew: true,
    gridSize: "large",
  },
  {
  ...
  },
  {
    ...
    name: "ChatMessage",
    description:
      "Chat transcript bubble with baked-in motion, user/assistant alignment, and file attachments.",
    isNew: true,
    gridSize: "small",
  },
  {
  ...
  },
  {
    ...
    name: "ColorPicker",
    description:
      "Color picker with HEX/RGB/HSL/OKLCH formats, alpha, swatches, and popover trigger.",
    gridSize: "large",
  },
  {
    slug: "dialog",
  ...
  },
  {
    slug: "input-copy",
    name: "InputCopy",
    description: "Read-only input with copy-to-clipboard button and animated feedback.",
    gridSize: "small",
  },
  {
    slug: "input-group",
  ...
  },
  {
    ...
    name: "InputMessage",
    description:
      "Chat-style message composer with auto-resizing textarea and configurable action slots.",
    isUpdated: true,
    gridSize: "medium",
  },
  {
  ...
  },
  {
    slug: "select",
    name: "Select",
    description: "Animated select menu with bordered/borderless variants and optional icons.",
    gridSize: "medium",
  },
  {
    slug: "slider",
    name: "Slider",
    description: "Range slider with step snapping, range mode, and animated thumb.",
    gridSize: "medium",
  },
  {
    slug: "switch",
  ...
  },
  {
    slug: "tabs",
    name: "Tabs",
    description: "Segmented control with sliding indicator and proximity hover.",
    gridSize: "medium",
  },
  {
    slug: "tabs-subtle",
  ...
  },
  {
    slug: "thinking-steps",
    name: "ThinkingSteps",
    description: "Chain-of-thought display with sequential animation and collapsible steps.",
    gridSize: "large",
  },
  {
    slug: "tooltip",
    name: "Tooltip",
    description: "Floating tooltip with spring-based animations and configurable placement.",
    gridSize: "small",
  },
];
