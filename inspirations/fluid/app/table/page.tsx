...
const quotes: Record<string, Quote[]> = {
  ...
  Ambition: [
    ...
    },
    {
      id: "a8",
      author: "Sam Altman",
      text: "It's easier to do a hard startup than an easy startup.",
      tag: "Ambition",
    },
    {
      id: "a9",
    ...
    },
    {
      id: "a40",
      author: "Sam Altman",
      text: "Great execution is at least ten times more important than a great idea.",
      tag: "Execution",
    },
    {
      id: "a41",
    ...
    },
    {
      id: "a49",
      author: "Naval Ravikant",
      text: "Free people make free choices. Free choices mean you get unequal outcomes.",
      tag: "Freedom",
    },
    {
      id: "a50",
  ...
  "Love & Life": [
    ...
    },
    {
      ...
      text: "No matter what, nobody can take away the dances you've already had.",
      tag: "Memory",
    },
    {
      id: "l10",
    ...
    },
    {
      id: "l16",
      author: "Khalil Gibran",
      text: "If you love somebody, let them go, for if they return, they were always yours.",
      tag: "Freedom",
    },
    {
      id: "l17",
    ...
    { id: "l19", author: "Leo Tolstoy", text: "If you want to be happy, be.", tag: "Simplicity" },
    {
      id: "l20",
      author: "Pablo Neruda",
      text: "In one kiss, you'll know all I haven't said.",
      tag: "Love",
    },
    {
      id: "l21",
    ...
    },
    {
      id: "l31",
      author: "Gabriel García Márquez",
      text: "Always remember that the most important thing in a good marriage is not happiness, but stability.",
      tag: "Partnership",
    },
    {
      id: "l32",
    ...
    { id: "l38", author: "Oscar Wilde", text: "Who, being loved, is poor?", tag: "Richness" },
    {
      id: "l39",
      author: "George Sand",
      text: "Guard well within yourself that treasure, kindness. Know how to give without hesitation.",
      tag: "Generosity",
    },
    {
      id: "l40",
    ...
    },
    {
      id: "l50",
      author: "Khalil Gibran",
      text: "And ever has it been known that love knows not its own depth until the hour of separation.",
      tag: "Loss",
    },
  ],
  Creativity: [
    { id: "c1", author: "Dieter Rams", text: "Less, but better.", tag: "Minimalism" },
    {
      id: "c2",
      author: "Jony Ive",
      text: "Simplicity is not the absence of clutter; that's a consequence of simplicity.",
      tag: "Simplicity",
    },
    {
      id: "c3",
    ...
    },
    {
      ...
      text: "Less is more only when more is too much.",
      tag: "Balance",
    },
    {
      id: "c9",
    ...
    },
    {
      id: "c22",
      author: "Dieter Rams",
      text: "My heart belongs to the details. I actually always found them to be more important than the big picture.",
      tag: "Craft",
    },
    {
      id: "c23",
      author: "Jony Ive",
      text: "We try to develop products that seem somehow inevitable.",
      tag: "Inevitability",
    },
    {
      id: "c24",
    ...
    },
    {
      id: "c25",
      author: "Paul Rand",
      text: "Everything is design. Everything!",
      tag: "Perspective",
    },
    {
      id: "c26",
    ...
    },
    {
      ...
      text: "An artist must not feel under any constraint.",
      tag: "Freedom",
    },
    {
      id: "c31",
      author: "Georgia O'Keeffe",
      text: "I've been absolutely terrified every moment of my life and I've never let it keep me from doing a single thing.",
      tag: "Courage",
    },
    {
      id: "c32",
    ...
    },
    {
      id: "c34",
      author: "Jony Ive",
      text: "The best products don't try to be noticed. They try to be useful.",
      tag: "Service",
    },
    {
      id: "c35",
    ...
    },
    {
      id: "c39",
      author: "Charles Eames",
      text: "Who ever said that pleasure wasn't functional?",
      tag: "Joy",
    },
    {
      id: "c40",
      author: "Massimo Vignelli",
      text: "There is no design without discipline. There is no discipline without intelligence.",
      tag: "Rigor",
    },
    {
      id: "c41",
    ...
    },
    {
      id: "c42",
      author: "Georgia O'Keeffe",
      text: "To create one's world in any of the arts takes courage.",
      tag: "Bravery",
    },
    {
      id: "c43",
    ...
    },
    {
      id: "c44",
      author: "Dieter Rams",
      text: "Being a designer is more than fulfilling a function. Design has to convey values.",
      tag: "Values",
    },
    {
      id: "c45",
      author: "Jony Ive",
      text: "Different and new is relatively easy. Doing something that's genuinely better is very hard.",
      tag: "Excellence",
    },
    {
      id: "c46",
    ...
    },
    {
      id: "c47",
      author: "Paul Rand",
      text: "The role of the designer is that of a good host, anticipating the needs of the guest.",
      tag: "Service",
    },
    {
      id: "c48",
    ...
    },
    {
      id: "c50",
      author: "Charles Eames",
      text: "Eventually everything connects — people, ideas, objects. The quality of the connections is the key to quality.",
      tag: "Connection",
    },
  ],
  Philosophy: [
    ...
    },
    {
      ...
      text: "Two things fill the mind with ever new admiration: the starry heavens above me and the moral law within me.",
      tag: "Wonder",
    },
    {
      id: "p7",
    ...
    },
    {
      id: "p15",
      author: "Hannah Arendt",
      text: "Forgiveness is the key to action and freedom.",
      tag: "Forgiveness",
    },
    {
      id: "p16",
    ...
    },
    {
      id: "p32",
      author: "Albert Camus",
      text: "Don't walk in front of me, I may not follow. Don't walk behind me, I may not lead. Walk beside me, and just be my friend.",
      tag: "Friendship",
    },
    {
      id: "p33",
      author: "Simone de Beauvoir",
      text: "Defending the truth is not something one does out of a sense of duty. It is a deep personal pleasure.",
      tag: "Truth",
    },
    { id: "p34", author: "Jean-Paul Sartre", text: "We are our choices.", tag: "Responsibility" },
    {
      id: "p35",
      author: "Hannah Arendt",
      text: "The world is not humane just because it is made by human beings.",
      tag: "Humanity",
    },
    {
      id: "p36",
    ...
    },
    {
      id: "p43",
      author: "Simone de Beauvoir",
      text: "Life is occupied in both perpetuating itself and in surpassing itself. If all it does is maintain itself, then living is only not dying.",
      tag: "Transcendence",
    },
    {
      id: "p44",
    ...
    },
    {
      id: "p45",
      author: "Hannah Arendt",
      text: "Storytelling reveals meaning without committing the error of defining it.",
      tag: "Narrative",
    },
    {
      id: "p46",
    ...
    >
      <div
        className={`absolute inset-0 rounded-[5px] border-solid transition-all duration-80 ${
          checked ? "border-[1.5px] border-transparent" : "border-[1.5px] border-border"
        }`}
      />
      <AnimatePresence>
        {checked && (
...
export default function TablePage() {
  ...
  return (
    <div className="flex flex-col gap-6 px-10 py-10 w-full">
      ...
      <TabsSubtle idPrefix="quotes" selectedIndex={selectedTab} onSelect={setSelectedTab}>
        {tabs.map((tab, i) => (
      ...
      {tabs.map((tab, i) => (
        <TabsSubtlePanel key={tab.label} index={i} selectedIndex={selectedTab} idPrefix="quotes">
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableRow key={q.id} index={idx}>
                  <TableCell className="text-center">
                    <div className="flex items-center justify-center">
                      <RowCheckbox checked={saved.has(q.id)} onToggle={() => toggleSaved(q.id)} />
                    </div>
                  </TableCell>
