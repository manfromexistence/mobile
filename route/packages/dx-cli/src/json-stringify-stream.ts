 ...
 * ```
 */
export function* jsonStringifyLines(value: unknown, indent: number = 2): Iterable<string> {
 ...
 */
function* stringifyValue(value: unknown, depth: number, indent: number): Iterable<string> {
  // Handle null
  if (value === null) {
    yield "null";
    return;
 ...
 */
function* stringifyArray(arr: unknown[], depth: number, indent: number): Iterable<string> {
  if (arr.length === 0) {
    yield "[]";
    return;
  }
