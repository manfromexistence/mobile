...
export const APIKEY_PROVIDERS_FRONTIER = {
  ...
  sarvam: {
    ...
    hasFree: true,
    freeNote:
      "Free tier: Sarvam 30B, 105B models — Indian multilingual AI, no credit card required",
    passthroughModels: true,
  ...
  "cohere-chat": {
    ...
    hasFree: true,
    freeNote: "Free trial for Cohere Chat API — no credit card required",
    passthroughModels: true,
  ...
  abliteration: {
    ...
    hasFree: true,
    freeNote: "Free uncensored AI models — no credit card required",
    passthroughModels: true,
