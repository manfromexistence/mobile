...
import type { GlowCard, GlowCardGrid } from "@/registry/components/glow-card-grid/glow-card-grid";
...
export type GitHubContributionsProps = ComponentProps<typeof GitHubContributions>;
