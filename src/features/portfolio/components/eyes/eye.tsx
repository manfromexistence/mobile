    ...
    <div
      ...
      style={{
        ...
        ...(style.backgroundColor === "#ff2d55" && {
          maskImage:
            "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M 50,25 C 50,20 45,8 30,8 C 15,8 5,20 5,35 C 5,55 30,75 50,92 C 70,75 95,55 95,35 C 95,20 85,8 70,8 C 55,8 50,20 50,25 Z' fill='black'/%3E%3C/svg%3E\")",
          maskSize: "contain",
