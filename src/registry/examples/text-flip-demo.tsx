...
export default function TextFlipDemo() {
  ...
  return (
    <div ref={ref} className="flex items-center gap-1.5 text-2xl font-medium text-muted-foreground">
      <span>I am a</span>
      <span className="inline-grid">
        ...
        <TextFlip as={motion.span} className="col-start-1 row-start-1 text-foreground" play={play}>
          {WORDS.map((word) => (
