...
export function ComponentItemIcon({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
export function ComponentItemDot({
  ...
  return (
    <span
      ...
      className={cn("absolute -top-1 -right-1 flex items-center justify-center", className)}
      {...props}
    >
