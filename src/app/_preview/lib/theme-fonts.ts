...
export const FONT_VAR_KEYS = ["font-sans", "font-mono", "font-serif", "font-heading"] as const;
...
export function extractFontVarsFromTheme(theme: RegistryItem): Map<string, string> {
...
export function applyThemeFonts(doc: Document, theme: RegistryItem, linkId: string): void {
