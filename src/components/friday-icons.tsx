...
export function PinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M12 17v5" />
      <path d="M9 10.76V6h6v4.76l3 2.24v3H6v-3l3-2.24Z" />
    </svg>
  );
}
...
export function ThumbsUpIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M7 10v12" />
      <path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H7V10l4.34-7.83A1 1 0 0 1 12.95 2a1 1 0 0 1 .55.13L15 5.88Z" />
    </svg>
  );
}
...
export function ThumbsDownIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M17 14V2" />
      <path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H17v12l-4.34 7.83a1 1 0 0 1-1.61.13L9 18.12Z" />
    </svg>
  );
}
...
export function BotIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M2 14h2M20 14h2M15 8V6a2 2 0 0 0-2-2h-2" />
    </svg>
  );
}
...
export function FolderOpenIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m6 14 1.5-5.5A2 2 0 0 1 9.45 7h8.1a2 2 0 0 1 1.95 1.55L20 10" />
      <path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v1H3V7Z" />
      <path d="M3 10h18l-2 8a2 2 0 0 1-2 1.5H5a2 2 0 0 1-2-1.5L3 10Z" />
    </svg>
  );
}
...
export function GithubIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.11.79-.25.79-.55 0-.27-.01-1.16-.02-2.11-3.2.7-3.87-1.36-3.87-1.36-.52-1.32-1.28-1.67-1.28-1.67-1.05-.72.08-.71.08-.71 1.16.08 1.77 1.19 1.77 1.19 1.03 1.77 2.7 1.26 3.36.96.1-.75.4-1.26.73-1.55-2.55-.29-5.24-1.28-5.24-5.7 0-1.26.45-2.29 1.18-3.1-.12-.29-.51-1.46.11-3.05 0 0 .97-.31 3.18 1.18a11.05 11.05 0 0 1 5.8 0c2.2-1.49 3.17-1.18 3.17-1.18.62 1.59.23 2.76.11 3.05.74.81 1.18 1.84 1.18 3.1 0 4.43-2.7 5.4-5.27 5.69.41.36.78 1.07.78 2.17 0 1.57-.01 2.83-.01 3.22 0 .31.21.67.8.55C20.21 21.38 23.5 17.08 23.5 12 23.5 5.65 18.35.5 12 .5Z" />
    </svg>
  );
}
...
export function PenToolIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m15 3 6 6-9 9-6 3 3-6 9-9Z" />
      <path d="m14 4 6 6" />
    </svg>
  );
}
...
export function PaperclipIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m21 12-9.5 9.5a5.5 5.5 0 0 1-7.78-7.78l9.5-9.5a3.5 3.5 0 0 1 4.95 4.95L9 19.5a1.5 1.5 0 0 1-2.12-2.12L15 9" />
    </svg>
  );
}
...
export function LinkIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07L12.3 18.76" />
    </svg>
  );
}
