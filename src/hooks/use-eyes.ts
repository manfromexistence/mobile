...
import { computeFrame, eyeStateToCSS, type Frame } from "@/lib/eyes-engine";
import { getAllAnimations, getAnimation, getAnimationsByTrigger } from "@/lib/eyes-registry";
import { type Animation, DEFAULT_EYE_STATE } from "@/lib/eyes-types";
