...
if (!content.includes('opencode-high')) {
  content = content.replace('export const MODEL_OPTIONS: Record<ModelId, ExtendedModelOption> = {', 'export const MODEL_OPTIONS: Record<ModelId | string, ExtendedModelOption> = {\n' + opencodeModels);
