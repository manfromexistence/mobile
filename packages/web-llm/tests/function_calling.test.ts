...
import { type ChatConfig, type ConvTemplateConfig, MessagePlaceholders, Role } from "../src/config";
import {
  getConversation,
  getConversationFromChatCompletionRequest,
  getFunctionCallUsage,
} from "../src/conversation";
import type { ChatCompletionRequest } from "../src/openai_api_protocols/chat_completion";
