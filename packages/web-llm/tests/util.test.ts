...
import type { ChatOptions } from "../src/config"
...
import type { ChatCompletionContentPartImage } from "../src/openai_api_protocols"
import {
  CustomLock,
  cleanModelUrl,
...
describe("Test getModelIdToUse", () => {
  test("Specified model not found", () => {
    ...
    expect(() => {
      ...
      new SpecifiedModelNotFoundError(loadedModelIds, requestModel, requestName)
    )
  })
